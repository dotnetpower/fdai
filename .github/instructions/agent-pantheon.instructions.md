...
| **Saga** | Auditor - append-only chain + handoff-to-GitHub-issue | governance | AuditEntry, Issue | `object.audit-entry`, `object.issue` | all terminal states, including `object.forecast-outcome` and `object.state-snapshot`; `object.handoff-escalation` | no | **yes** |
