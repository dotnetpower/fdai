...
| **Thor** | Responder - **sole privileged executor**; MUST NOT judge | pipeline | ActionRun, ActionAttempt | `object.action-run` | `object.verdict`, `object.approval`, `object.rollback`, `object.recovery-effect-observation` (exact verified ActionRun closure only) | no | no |
