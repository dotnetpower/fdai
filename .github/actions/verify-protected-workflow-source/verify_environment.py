#!/usr/bin/env python3
"""Verify the approval policy for one protected GitHub Environment."""
...
def verify(payload: object, *, required_approvals: int) -> None:
    """Require one reviewer rule with self-review and admin bypass disabled."""
    ...
    if (
        ...
        or any(
            ...
            or item["reviewer"].get("id") is None
