...
| `trace_window_seconds` | string | Trace-continuity detection window. One window yields at most one finding, so it MUST stay several times shorter than the correlation window. Empty -> analyzer window. |
