...
Counterpart of ``scripts/quality/localization/refresh-translation-sha.py``. Where that tool
...
the drift signal that ``scripts/quality/localization/check-derived-sources.py`` provides.
