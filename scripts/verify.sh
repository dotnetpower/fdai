...
run_gate_scoped "package-assurance" '^(config/package-assurance\.json$|pyproject\.toml$|services/[^/]+/pyproject\.toml$|packages/[^/]+/pyproject\.toml$|extensions/[^/]+/pyproject\.toml$|scripts/quality/architecture/check-package-assurance\.py$|tests/integration/scripts/test_package_assurance\.py$)' "${python_runner[@]}" scripts/quality/architecture/check-package-assurance.py
...
run_gate_scoped "workflow-promotion-verdicts" '^(config/workflow-promotion-verdicts(\.schema)?\.json$|docs/roadmap/agents/agent-workflow(s|-rollout)(-ko)?\.md$|scripts/quality/architecture/check-workflow-promotion-verdicts\.py$|services/core-control-plane/src/fdai/agents/_framework/workflows\.py$|tests/integration/scripts/test_workflow_promotion_verdicts\.py$)' python3 scripts/quality/architecture/check-workflow-promotion-verdicts.py
...
run_gate_scoped "action-type-runtime-support" '^(config/action-type-runtime-support(\.schema)?\.json$|rule-catalog/action-types/|packages/service-contracts/src/fdai_service_contracts/executor_targets\.py$|services/core-control-plane/src/fdai/(runtime/(delivery|t2_route_registry)\.py|delivery/(azure/gateway_direct_api|graph_model_promotion|promotion|identity/direct_api)\.py)$|scripts/quality/architecture/check-action-type-runtime-support\.py$)' uv run python scripts/quality/architecture/check-action-type-runtime-support.py
