...
REPO_ROOT = next(parent for parent in _HERE.parents if (parent / "pyproject.toml").is_file())
...
BEST_PRACTICES_DIR = CATALOG_ROOT / "best-practices"
PROBES_DIR = CATALOG_ROOT / "probes"
ARCHITECTURE_REVIEW = REPO_ROOT / "config" / "architecture-review.yaml"
