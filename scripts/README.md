...
Changes to global Python test configuration, composition wiring, rule catalog
data or loaders, shared contracts and provider interfaces with cross-repository
