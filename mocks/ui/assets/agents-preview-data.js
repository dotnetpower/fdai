...
(function () {
  ...
  const agents = [
    ...
    { name: "Heimdall", role: "Observer", layer: "pipeline", manager: "Forseti", owns: "Anomaly, Drift, Forecast, ForecastOutcome, RetrievalValidation, EvidenceConflict, RecoveryEffectObservation", state: "watching", since: "09:42:00", work: "Monitoring discovery freshness and observation coverage", summary: "Correlates signals into findings. Freshness and coverage are evidence, not health guarantees." },
    { name: "Huginn", role: "Event Collector", layer: "pipeline", manager: "Forseti", owns: "Event, Change", state: "watching", since: "09:40:00", work: "Normalizing the synthetic inventory ingress", binding: "raw ingress subscriber", summary: "Owns resource-discovery ingress and event normalization. Cloud I/O remains in adapters." },
    { name: "Forseti", role: "Judge", layer: "pipeline", manager: "Odin", owns: "Verdict, SecurityEvent, ArbitrationRequest, ProspectiveLineage", state: "engaged", runtimeState: "deciding", since: "09:44:58", incident: "sample-change", work: "Reviewing a change that requires human approval", flags: "Hot-path LLM (T2 only)", summary: "Issues auto, hil, or deny verdicts after grounding, cross-check, and deterministic verification." },
    ...
    { name: "Thor", role: "Responder", layer: "pipeline", manager: "Odin", owns: "ActionRun", state: "idle", since: "09:43:00", work: "Waiting for an authorized, verified action", summary: "Sole privileged executor; dispatches governed actions and never judges." },
    ...
    { name: "Bragi", role: "Narrator", layer: "pipeline", manager: "Thor", owns: "Conversation, Turn, UserPreference, HandoffEscalation, PostTurnReview", state: "idle", since: "09:35:00", work: "Waiting for a grounded operator question", flags: "Hot-path LLM (T2 only)", summary: "Conversational-port translator only. Does not call an executor directly or grant authority." },
    { name: "Njord", role: "Cost", layer: "domain", manager: "Forseti", owns: "CostAnomaly", state: "unobserved", binding: "external adapter", summary: "Cost and FinOps specialist. Advises Forseti and does not execute." },
    { name: "Freyr", role: "Capacity", layer: "domain", manager: "Forseti", owns: "CapacityForecast, CapacityGraduationRecommendation", state: "unobserved", binding: "external adapter", summary: "Capacity and forecast specialist. Advises Forseti and does not execute." },
    ...
    { name: "Mimir", role: "Rule Steward", layer: "governance", manager: "Odin", staff: true, owns: "Rule, Policy, RuleGenerationBuildRequest, RuleGenerationBuildResult", state: "idle", since: "09:06:00", work: "Waiting for rule-catalog changes", summary: "Owns the rule catalog and grounds Forseti's judgments in current rules." },
