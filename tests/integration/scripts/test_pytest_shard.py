...
def test_shard_assignment_is_stable_and_bounded() -> None:
    path = Path("services/core-control-plane/tests/core/risk_gate/test_gate.py")
...
def test_each_file_is_assigned_to_exactly_one_shard() -> None:
    paths = (
        Path("services/core-control-plane/tests/core/risk_gate/test_gate.py"),
        Path("services/core-control-plane/tests/core/quality_gate/test_gate.py"),
        Path("services/core-control-plane/tests/delivery/operator_api/test_local.py"),
    )
