...
from fdai.delivery.operator_api.dev.helpers import build_inventory_graph_provider
from fdai.delivery.operator_api.routes.inventory_graph import InventoryGraphViewNotFoundError
...
def test_cache_serialization_failure_keeps_live_snapshot_available(
    ...
    from fdai.delivery.operator_api.dev import azure_inventory_graph as module
