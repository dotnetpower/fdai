...
class WorkflowOperation(StrEnum):
    ...
    RULE_ACTIVATION_STATUS = "rule.activation-status"
    RULE_ACTIVATION_HISTORY = "rule.activation-history"
    RULE_ACTIVATION_REQUEST = "rule.activation-request"
    RULE_ACTIVATION_APPROVE = "rule.activation-approve"
