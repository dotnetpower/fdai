...
WORKFLOW_FAMILY_ROUTE_MANIFEST: tuple[WorkflowRouteSpec, ...] = (
    ...
    WorkflowRouteSpec(
        ...
        "/rules/activation",
        "activation_status",
        WorkflowOperation.RULE_ACTIVATION_STATUS,
        "read",
    ),
    WorkflowRouteSpec(
        "POST",
        "/rules/activation-changes",
        "request_activation_change",
    ...
    WorkflowRouteSpec(
        "GET",
        "/rules/{rule_id}/activation-history",
        "activation_history",
        WorkflowOperation.RULE_ACTIVATION_HISTORY,
        "read",
        pagination=PaginationSpec(50, 200, supports_offset=False),
    ),
    WorkflowRouteSpec(
        "GET",
