...
from fdai_operator_service.families.conversation.semantic_assurance_presentation import (
    pantheon_assurance_payload as _pantheon_assurance_payload,
)
from fdai_operator_service.families.conversation.semantic_assurance_presentation import (
    pantheon_done_event_data as _pantheon_done_event_data,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_citations_block as _incident_citations_block,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_impact_block as _incident_impact_block,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_next_step_rows as _incident_next_step_rows,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_profile_items as _incident_profile_items,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_root_cause_block as _incident_root_cause_block,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    incident_timeline_block as _incident_timeline_block,
)
from fdai_operator_service.families.conversation.semantic_incident_presentation import (
    readable_gap as _readable_gap,
)
from fdai_operator_service.families.conversation.semantic_trajectory_presentation import (
    semantic_technical_trajectory,
)
from fdai_operator_service.families.conversation.semantic_trajectory_presentation import (
    verified_query_command as _verified_query_command,  # noqa: F401 - compatibility alias
)
...
def semantic_done_event_data(
    ...
    *,
    ...
    context_draft = payload.get("test_context_draft") if isinstance(payload, Mapping) else None
