    ...
    (
        (
            ...
            (
                ...
                "publish Verdict, SecurityEvent, ArbitrationRequest, and ProspectiveLineage",
                "RCA remains a core causal-hypothesis projection",
        ...
        (
            ...
            (
                ...
                "결정론적 규칙과 정책을 먼저 적용",
                "잔여 모호성에만 검증이 적용된 T2",
                "Verdict, SecurityEvent, ArbitrationRequest 및 ProspectiveLineage를 게시",
                "RCA는 core causal-hypothesis projection",
                "작업을 승인하거나 실행하지 않습니다.",
            ),
        ),
        (
    ...
    (
        (
            ...
            (
                ...
                "I report to Forseti.",
                "CostAnomaly bus publication",
                "separate Budget graph lifecycle",
                "never judge, approve, or execute an action",
    ...
    (
        (
            ...
            (
                ...
                "I report to Forseti.",
                "CapacityForecast and CapacityGraduationRecommendation bus publication",
                "separate SizingRecommendation graph lifecycle",
        ...
        (
            ...
            (
                ...
                "Forseti에게 보고합니다.",
                "CapacityForecast와 CapacityGraduationRecommendation을 게시",
                "별도 SizingRecommendation graph lifecycle",
