...
class TeamsTokenConfig:
    """Exact Bot application and service-token validation policy."""
...
class VerifiedTeamsServiceToken:
    """Claims retained after signature, time, audience, and issuer verification."""
...
class TeamsServiceTokenVerifier:
    """Resolve one RS256 key by kid and verify all decision-critical claims."""
