...
Kept apart from the job that runs it: a settings change and a collection change
have different reasons to change, and the bounds below are the only place a
deployment can widen them.
"""
