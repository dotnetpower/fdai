...
OPERATOR_REQUEST_CONSUMER_V18 = ConsumerCodec(
    "operator-core-request",
    "N",
    (
        "1.0.0",
...
OPERATOR_PROJECTION_PRODUCER_V17 = ProducerCodec("core-operator-projection", "N", "1.7.0")
...
__all__ = [
    name
    for name in globals()
    if name.endswith(("_V1", "_V11", "_V12", "_V13", "_V14", "_V15", "_V16", "_V17", "_V18"))
]
