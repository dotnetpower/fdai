...
| C6 other sources and operator presentation | not-started | Owner design | Azure policy, artifact, capacity, storage, egress and installation-owner collectors, Console/ChatOps delivery, installed-observer suppression and governed installation remain open. |
