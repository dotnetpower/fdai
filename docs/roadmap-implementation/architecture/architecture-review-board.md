...
| Evidence attestation and decision authority | in-progress | [Focused owner](../../roadmap/architecture/architecture-review/evidence-and-authority.md); [delivery ledger](architecture-review/evidence-and-authority.md); `core/architecture_review/readiness.py`; focused readiness tests | The reusable checker now rejects accepted critical and high blockers without a complete current risk or exception contract. Provider-backed evidence attestation and immutable decision binding remain open. |
