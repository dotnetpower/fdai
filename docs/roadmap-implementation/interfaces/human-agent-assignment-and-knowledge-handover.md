...
- [ ] Complete ACL-filtered agent retrieval, agent-owned gap and candidate events, localized Bragi rendering, and candidate promotion; conflict fencing and read-time staleness/deletion propagation now have focused passing evidence.
