...
| Governance navigation visibility | implemented | `console/src/components/navigation-shell.tsx`; focused shell, router, and browser tests; Console typecheck | Governance Explorer omits Architecture while the registered panel and direct `/architecture` route remain available. |
