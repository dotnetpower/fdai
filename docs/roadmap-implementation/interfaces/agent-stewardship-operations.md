...
|------|-------|--------|----------|-----------|
| 2026-09-14 | implemented | Added explicit AKS workload authentication to the shared ingestion host without changing stewardship signature verification, draft review or owner authority. | Current change; API/worker credential selection and service composition tests passed with service isolation preserved. | Retain live AKS identity evidence separately; stewardship lifecycle and authority remain unchanged. |
