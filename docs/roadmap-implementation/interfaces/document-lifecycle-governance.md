...
| Console lifecycle controls | implemented | Console ingestion client, upload settings, document library, Vitest and Playwright | Operators choose governed knowledge or expiring draft, see expiry/disposition, inspect immutable version history, act on an exact version, and confirm promotion before the request is sent. |

### Implementation history

| Date | State | Change | Evidence | Remaining |
|------|-------|--------|----------|-----------|
| 2026-09-17 | implemented | Added unchanged governed-upload reuse and selected-version history actions without mutating prior records or automatically restoring a deleted active version. | `current change`; issue #1277; ingestion service, preview/download boundaries, Console version workspace, 71 focused backend checks, 17 Console checks, and 4 browser scenarios. | Deployed authorization and lifecycle evidence remains separate. |
