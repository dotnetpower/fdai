...
| Reserved parser support | not-started | [Reserved-but-unimplemented parsers](../../roadmap/rules-and-detection/rule-catalog-profiles.md#reserved-but-unimplemented-parsers) | `checkov-yaml` and `gatekeeper-templates` remain explicit fail-closed placeholders. |
