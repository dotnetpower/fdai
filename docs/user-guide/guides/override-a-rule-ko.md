...
translation_source_sha: 69389ef6faaf02fa55768dfb560f072f2eb9ac22
...
- **`severity-downgrade`** - 규칙은 계속 발동하지만 낮은 severity를 적용합니다(예:
  `critical -> medium`). 안전성 검토는 변경된 탐지 결과를 다시 평가합니다. Override는
...
Override는 자율성을 낮추는 제어입니다. 사람 승인을 AUTO로, DENY를 사람 승인으로, shadow를
적용 모드로 바꾸지 않습니다.
...
| 학습 대상 | 문서 |
|-----------|------|
| severity와 auto/사람 승인/DENY의 실행 시점 의미 | [../concepts/risk-tiers-ko.md](../concepts/risk-tiers-ko.md) |
