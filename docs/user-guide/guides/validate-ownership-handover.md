...
| OP-04 Current people and duties | Review the v2 shape and distinct-person rules without populating the upstream map | Identity/ownership reviewer verifies all 15 agents, two distinct maintainers, current primary plus distinct backup coverage for every non-autonomous agent, exact scope/effective dates, current group/schedule expansion and static fallback, plus separate role eligibility. |
