...
## Before an incident: Detected issues
...
a `Finding` has no Incident lifecycle by itself. Correlation can submit an Incident candidate, and
a manual workflow can submit an Incident proposal. Only the incident lifecycle module can accept
