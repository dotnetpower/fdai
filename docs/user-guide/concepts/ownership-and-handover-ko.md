...
translation_source_sha: 2c324b605b023995fe95d28188e3885dcfdc84a6
...
![인수인계 문서는 안전 검사를 거친 수집, 출처를 인용하는 결정적 추출, 선택적 근거 기반 해석, 정확한 디렉터리 신원 확인, 신뢰도 및 담당 범위 경고, 고정된 에이전트 집합에 대한 계약 검증, 멱등한 검토 전용 초안 pull request, 독립된 사람 검토, 병합 후 로더 검증 및 감사를 거칩니다. 미해결, 보류, 거부 또는 잘못된 제안은 활성 담당 체계를 바꾸지 않으며 담당 체계는 접근 권한이나 실행 권한을 부여하지 않습니다.](../../diagrams/generated/fdai-ownership-and-handover-01.ko.svg)
