...
| 13b | [alert-noise-governance.md](operations/alert-noise-governance.md) | shadow-first alert assessment, audience evidence, exact-plan manual-PR actions, protected paths, and independent effect verification; operational adoption remains gated |
| 13c | [aks-commerce-business-scenario.md](operations/aks-commerce-business-scenario.md) | public storefront journey, AKS and messaging evidence, workload SLO impact, deterministic diagnosis, governed recovery, and independent business-effect verification |
...
| 20f | [runtime-deployment-profiles.md](deployment/runtime-deployment-profiles.md) | new-install Container Apps or AKS selection, node floors, database placement, separate states, and signed-kit execution |
...
| 15f | [human-report-lines-and-approval-routing.md](interfaces/human-report-lines-and-approval-routing.md) | governed organization-chart extraction, edge confirmation, independent Owner review, requester contact consent, and nearest eligible report-line approval routing |
...
| 19a.1 | [cloud-resource-knowledge-lifecycle.md](interfaces/cloud-resource-knowledge-lifecycle.md) | proposed collection-date-aware CSP documentation, weekly/monthly refresh, reviewed offline packages, atomic knowledge activation, and dated answers |
