...
translation_source_sha: c42d33790f7ec5e97855177d14ca91a8a028ace1
...
| 2026-09-05 | implemented | Service 적용 후 스키마를 변경하는 카탈로그 수명 주기 회귀를 직렬화하고 forward Core 마이그레이션으로 root 소유 T2 lookup index를 복원했습니다. | `current change`, 집중 마이그레이션 계약 및 일회용 PostgreSQL 수명 주기 검사 | 배포 전에 exact green required CI 증적을 보존합니다. |
