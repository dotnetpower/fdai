...
translation_source_sha: a62650b055ae5469eec7b89d2f1307d670a1a998
...
`reconcile_rca_bootstrap_state.sh`로 Azure 리소스를 변경하지 않고 알려진 legacy measurement Job
state 주소 두 개를 조정한 뒤 identity와 역할만 대상으로 합니다. State digest를 기록하고 legacy
및 현재 주소가 함께 있으면 실패합니다. 두 plan guard도 계속 적용됩니다.
