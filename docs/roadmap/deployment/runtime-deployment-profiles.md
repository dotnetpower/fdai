...
Each one-shot inventory process closes its runtime-settings, ontology-status, and collection-health
database pools through the same asynchronous lifecycle that closes provider clients and event transport.
