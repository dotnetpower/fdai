...
translation_source_sha: 26e565db1cc4b1765f1afe8a5eae0b057331bc2c
...
파생합니다. 별도의 추가 방식 메타데이터 필드는 Core 또는 Operator 중 어느 쪽을 먼저 업데이트해도
기본 인벤토리 조회를 계속 사용할 수 있게 합니다.
