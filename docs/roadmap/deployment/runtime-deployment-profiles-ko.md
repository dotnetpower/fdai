...
translation_source_sha: d7b11254af80364713f06cc295b24371a86ee356
...
파생합니다. 새 출처 레코드는 별도의 추가 방식 메타데이터 필드를 사용하므로 Core 또는 Operator
중 어느 쪽을 먼저 순차 업데이트해도 기본 인벤토리 조회가 사용 불가로 바뀌지 않습니다.
