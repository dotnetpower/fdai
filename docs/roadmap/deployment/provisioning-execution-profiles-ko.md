...
translation_source_sha: 4d9a8236be5809611608baaf259000b45a57a7a3
...
- [ ] 테넌트 실행의 Docker, Buildx, ACR Tasks 및 VM 이미지 캡처 경로를 제거하고, 미리 빌드한 서명 이미지 매니페스트와 배포된 digest 재확인을 요구합니다.
