...
translation_source_sha: c6d896b46d3700c412dcda22b687f6a058b05294
...
- [ ] 후속 CLI 하드닝 13회를 포함한 완전한 대체 키트를 게시하고 정확한 설치 아티팩트 검증을 반복합니다. 앞선 r2 아티팩트에는 이 변경이 없습니다.
...
제한을 유지하며 만료 시 새로 만든 부분 다운로드만 삭제하고 재시도하지 않습니다.
