...
To keep the workflow reviewable, dedicated repository modules build protected plan metadata and
apply receipts. The YAML passes only sealed inputs and explicit output paths to those builders.
