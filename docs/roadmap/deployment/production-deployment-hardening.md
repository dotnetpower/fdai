...
|------|-------|--------|----------|-----------|
| 2026-09-05 | implemented | Restored the apply job's GitHub Environment binding after workflow consolidation and extended the protected-main preflight action to verify one reviewer rule with self-review and administrator bypass disabled before target checkout. | `current change`; focused protected-action and deployment workflow contract tests. | Retain one independently approved exact apply receipt. |
