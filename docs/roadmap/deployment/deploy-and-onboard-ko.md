...
translation_source_sha: 1da111970f1109907709d5f9572b2d742289aaae
...
target으로 지정합니다. 기존 environment, subnet, DNS zone 및 secret의 안정된 resource ID를
사용하여 관련 없는 compute module 입력이나 infrastructure drift가 범위 제한 계획에 들어오지
