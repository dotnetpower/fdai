...
translation_source_sha: 6145b1def51799cf0063221b356bb6481623aac6
...
적용을 활성화합니다. 이후 일반 배포 계획이 명시적 선택 리소스의 제거를 제안하지 않고 보존하도록
해당 계획 전에 `ENABLE_OPERATIONAL_HISTORY` repository 변수를 `true`로 설정합니다.
