...
translation_source_sha: 7dede6c8713b51c64cae55a4434444cd4471180a
...
audience를 받는 core Container App 및 두 dependency graph를 target합니다. 관련 없는 pending Event
Hub와 다른 runtime resource 변경은 plan에서 제외됩니다. Terraform은 `AzureWebJobsStorage`가 reader managed identity를 사용하도록 구성하며,
