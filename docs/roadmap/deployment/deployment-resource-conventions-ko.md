...
translation_source_sha: b560cb3e26317032546afb71b89a9ef700320fcf
...
| 보호된 모델 해석 및 endpoint 산출물 | implemented | `.github/workflows/deploy-dev.yml`; model binding sealer; 정확한 기능 gate; `llm_model_endpoints` Terraform 출력; 보호된 서비스 구체화; 집중 검사 | 보호된 계획은 결정론적 binding과 모델 digest를 봉인합니다. ChatOps 검증은 Terraform 전에 정확한 배포 소유 Foundry 참조가 있는 검토된 Mistral 프로필만 수락합니다. |
