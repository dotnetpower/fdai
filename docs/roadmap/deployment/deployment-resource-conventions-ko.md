...
translation_source_sha: 600a569277382ba144992a0a49a914bf6ed04494
...
| 보호된 모델 해석 및 endpoint 산출물 | implemented | `.github/workflows/deploy-dev.yml`; model binding sealer; `llm_model_endpoints` Terraform 출력; 보호된 서비스 구체화; 집중 검사 | 보호된 계획은 결정론적 binding과 모델 digest를 봉인합니다. Terraform은 계정으로 한정된 정확한 origin을 내보내며 독립 Core 구체화는 누락되거나 일치하지 않는 Foundry 범위를 차단합니다. |
