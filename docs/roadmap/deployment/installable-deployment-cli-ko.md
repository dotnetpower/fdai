...
translation_source_sha: c0db7d6b7d60c7d989955f61f49fc3beb3944157
...
별도의 소스 기반 Foundation 계획 명령까지 지원합니다. 고급 Foundation 어댑터는 소스 입력으로
정확한 계획의 적용을 준비하고 비공개 상태를 이전할 수 있지만, 공개 소스 명령은 아직 이 단계를
진행하지 않습니다. 관리 호스트의 애플리케이션 실행과 영속 Trial 활성화도 아직 연결되지
