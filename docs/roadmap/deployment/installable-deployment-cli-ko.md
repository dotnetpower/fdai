...
translation_source_sha: d29e6dc3fae15f89753643f324776119c348601b
...
`fdaictl`은 설치된 Python을 고정된 Genesis 실행기에 전달하며 계획 생성과 재검증도 같은 CLI 인터프리터를 사용합니다. 모든 Terraform 바이너리와 공급자 경로는 원본 키트가 아니라 비공개 스냅샷을 사용합니다.
