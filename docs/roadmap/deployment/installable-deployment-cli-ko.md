...
translation_source_sha: 5bd103910016885598434e789e7d36c45d023baa
...
합니다. 가져오기·교체·삭제·역할 확대는 거부합니다. 실행 전 기록이 있는 일반 적용 경로는
...
복사한 구성에는 애플리케이션 이름 변경만 허용합니다. 원래 상태 경로를 Terraform에 직접
