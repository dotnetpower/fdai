...
translation_source_sha: f917ba31a2142397c8c42cba3deaaf2c0ea80072
...
기록이 있으면 계획 만료 후에도 현재 검증된 게시기로 후보를 다시 게시하지 않고 결과만 확인합니다. 롤백 콘텐츠를 먼저 확인하고 두 산출물 모두 없을 때만 롤백을 게시합니다. 게시 실패나 기록된 후보 콘텐츠 불일치가 발생하면 종료 실패 증적을 기록합니다. 성공하려면
