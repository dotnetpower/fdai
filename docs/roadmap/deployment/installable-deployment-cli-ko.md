...
translation_source_sha: cad9f94cb6923105c7ee24a9b79a556f05e22153
...
| Offline 키트 및 폐쇄망 계획 | in-progress | `fdai_deployment_cli.offline_kit`, 릴리스 스크립트, 서명, 정확한 파일 집합, 호환성, 변조 집중 검사 | 패키징은 준비 호스트 플랫폼을 파생하고 해시 운영 의존성, CLI, 모든 전이 바이너리 wheel을 준비하며 명시적 교차 플랫폼 표시는 차단합니다. 네트워크 없는 Terraform air-gap 훈련은 아직 실행해야 합니다. |
