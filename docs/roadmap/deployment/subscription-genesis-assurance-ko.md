...
translation_source_sha: 42c62ad67a5ad14badd7e0f2cc9a4d2408965014
...
완전한 준비 상태는 별도의 근거 게이트로 유지합니다. 기반 계층의 직접 실행과 정리 실패도 개인 인자와 파일 경로를 출력하지 않습니다. 정리는 성공 보고 전에 수행하며 원래 실패를 보존합니다.
