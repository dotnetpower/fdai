...
translation_source_sha: bb3840aeca9a5e3d120cacbb7cce774111798250
...
완전한 준비 상태는 별도의 근거 게이트로 유지합니다. 기반 계층의 직접 실행과 정리 실패도 개인 인자와 파일 경로를 출력하지 않습니다. 정리는 성공 보고 전에 수행하며 원래 실패를 보존합니다. 주 스레드의 중첩 Genesis 실행은 종료 신호를 전달하고 상위 종료 유예 안에 자식 정리를 마칩니다.
