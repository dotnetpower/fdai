...
translation_source_sha: 60d1424e4aaf3704464ba6f98720139788a4fd43
...
ARG는 생성된 쿼리, 검토된 관계 카탈로그와 전송 설정도 고정합니다. 청크 재생은 후보 데이터만 복원합니다. 공급자 스트림을 재개해 완료하려면 연속 조회의 유효성,
