...
translation_source_sha: c24fc0b53d8b2208ab538a62b8823aab69171cd5
...
| Teams, Slack 및 아웃바운드 알림 어댑터 | in-progress | [`teams_adapter.py`](../../../services/core-control-plane/src/fdai/delivery/chatops/teams_adapter.py), [`slack_transport.py`](../../../services/core-control-plane/src/fdai/delivery/channels/slack_transport.py), [`teams_transport.py`](../../../services/core-control-plane/src/fdai/delivery/channels/teams_transport.py), 집중 channel 검사 92개 통과 | Teams는 `HilChannel`을 구현하고 Slack과 Teams는 아직 조립되지 않은 운영 A3 전송을 구현했으며 A2/A4 알림 adapter는 집중 테스트를 통과했습니다. Slack `HilChannel`, A1 callback, Entra 재인증 흐름, 운영 A3 런타임 및 배포된 전송 증적은 없습니다. |
