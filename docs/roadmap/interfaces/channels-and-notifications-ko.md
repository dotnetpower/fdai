...
translation_source_sha: e93ef4ed6827daddde40fd0ab055170f3d6089ca
...
| Teams, Slack 및 아웃바운드 알림 어댑터 | in-progress | [`teams_adapter.py`](../../../services/core-control-plane/src/fdai/delivery/chatops/teams_adapter.py), Core-local Slack/Teams transport prototype, 집중 channel 검사 92개 통과 | Teams는 `HilChannel`을 구현하고 A2/A4 알림 adapter는 집중 테스트를 통과했으며 A3 prototype은 ingress와 publisher algorithm을 증명합니다. 운영 A3 transport는 Operator 소유권으로 이동해야 합니다. Slack `HilChannel`, A1 callback, Entra 재인증 흐름, 운영 A3 runtime 및 배포된 transport 증적은 없습니다. |
