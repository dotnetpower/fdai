...
The Assurance Twin's withheld posture and change-review gaps remain separate status regions with
visible evidence identities and reasons on the narrow Console route. The focused responsive and
accessibility check verifies those read-only regions without turning a gap into an action control
or a successful report.
