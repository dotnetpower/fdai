...
Every Command Deck date and time label explicitly uses the active Console language. The browser or operating-system locale cannot introduce Korean day-period text into an English conversation, or English day-period text into a Korean conversation.
