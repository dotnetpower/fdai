...
- [ ] Pass the PostgreSQL pipeline persistence test against the supported live-database fixture and retain the focused result before raising persistence to `implemented`.
