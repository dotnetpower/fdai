...
| Planner intent coverage | Implemented | Import and exhaustive tests fail when a runtime intent has no server-owned default evidence plan, preventing a late request-time key error. |
