...
The Operator API is a shared non-privileged relay, not a workflow engine or hidden agent, and never
holds Thor's executor identity. Agents communicate through typed events, not direct calls.
