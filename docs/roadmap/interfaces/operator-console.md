...
The production layout uses visible headings for source notices, follows the provisioning mock's run summary, and separates Stages, Readiness, and Resources into keyboard-accessible views without copying mock-only lifecycle data.
