...
The packaged Core development diagnostics module serves only an explicitly enabled local owner-only Unix socket; it adds no Console, Operator HTTP, or authority-bearing route.
