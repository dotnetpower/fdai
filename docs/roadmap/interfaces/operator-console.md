...
The production layout follows the provisioning mock's run summary and separates Stages, Readiness, and Resources into keyboard-accessible views without copying mock-only lifecycle data.
