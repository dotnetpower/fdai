...
Authenticated projection readers keep driver placeholders and expression grouping explicit so
stored data is not hidden by SQL parsing errors. Live health summaries and document identity rows
reflow inside the primary content at 1440, 993, and 390 pixel widths.
