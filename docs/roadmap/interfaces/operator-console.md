...
Vertical Outcomes keeps Resilience, Change Safety, and Cost Governance visible when attribution is missing. It reports missing values as unavailable, and it presents zero savings only when at least one cost event was observed in the measurement window.
