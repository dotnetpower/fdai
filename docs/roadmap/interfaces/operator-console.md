...
| System Knowledge role catalog | Regeneration can refresh cited Pantheon bus ownership and subscription facts while graph lifecycle ownership remains separate. It changes no Console data source, AKS scenario behavior, human reporting line, approval route, or execution authority. |
