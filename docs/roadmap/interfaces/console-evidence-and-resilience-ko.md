...
translation_source_sha: 5a40a5db7d31cd04a8bb50b01adbbfce72514e4d
...
Sample 자율성 예시는 운영 성과 지표 5개마다 8개 구간의 추세를 제공합니다. 비용 거버넌스는 경로에 따라 비용, `optimization_case`, `outcome` 레코드를 구분해 선택합니다. 모든 레코드는 `synthetic-preview` 출처를 유지하고 지원하지 않는 정산 및 단위 경제 필드는 사용 불가 상태로 남깁니다.
