...
translation_source_sha: 578fd4247f96ce54192ed8b1ecbf2e639ca8f5ee
...
승인된 실측군 비교는 현재 Live 값과 분리되고 유효 기간이 있으며 어떤 권한도 부여하지 않습니다. 캡처한 화면 컨텍스트도 현재 기준선을 대체하지 않고 두 군과 유효 기간을 보존합니다.
