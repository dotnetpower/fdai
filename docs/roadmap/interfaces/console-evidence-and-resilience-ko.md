...
translation_source_sha: 212225e135ac8057271ae3f4f7c548b04fd77273
...
Assurance Twin에서 보류된 자세와 변경 검토 근거 공백은 좁은 콘솔 화면에서 각각
상태 영역으로 유지하며, 근거 식별자와 이유를 표시합니다. 집중 반응형 및 접근성
검사는 이 읽기 전용 영역을 확인하고 근거 공백을 작업 제어나 성공한 보고서로
표시하지 않는지 검사합니다.
