...
translation_source_sha: 7eba548f7450e040d29b2c00d4be0385a533afd7
...
좁은 화면에서 현재 담당자 화면은 넓은 비교 표를 레이블이 있는 에이전트별 레코드로 바꿉니다.
반응형 표시는 모든 필드를 유지하며 적용 범위나 근거를 변경하지 않습니다.
