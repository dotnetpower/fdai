...
translation_source_sha: 7eab8cfca6bebcbecb15f464a43e338b56c8cd22
...
Dashboard v2는 타입이 지정된 인벤토리 또는 온톨로지 세대 전환에만 제한된 전체 페이지 탐색을
다시 시작합니다. 일부 페이지를 버리고 처음 시작한 제한 시간을 지연된 재시도 2회와 공유하며,
지속되는 불일치는 세대를 섞거나 빈 인벤토리를 반환하지 않고 계속 표시합니다.
