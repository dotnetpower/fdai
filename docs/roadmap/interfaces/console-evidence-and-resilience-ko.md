...
translation_source_sha: 6a739277e98077bf54492e9e3893f448b20a25fa
...
`llm-model-deployment` 하위 리소스는 runtime layer, 기존 Azure application-service 색상
계열, 안정적인 `model` 약어를 사용하고 상위 리소스는 `llm-endpoint`로 유지합니다.
