...
translation_source_sha: 7f951c51b706986c63ab29819dcf953419b65065
...
있습니다. 구성 기준선, Skills, 대화 전달, 예측 학습에도 공통 근거 새로 고침 버튼을 제공합니다. 기존 변환 결과만 다시 읽고, 로딩 골격과 중복 실행 방지를 적용하며, 현재 보기를 유지합니다. 스킬 설치, 프로바이더 호출 또는 권한 상승은 수행하지 않습니다.
