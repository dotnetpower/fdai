...
translation_source_sha: a4d515471121e9e01a477e59b56d2d97aa5a126d
...
운영 화면은 소스 안내에 보이는 제목을 사용하고 프로비저닝 목업의 실행 요약을 따르며, 단계, 준비 상태, 리소스를 키보드로 조작할 수 있는 보기로 구분하되 목업 전용 수명 주기 데이터는 복사하지 않습니다. Console 카탈로그가 바뀌면 소스에 결속된 질문 bank를 먼저 갱신한 뒤 semantic-intent coverage와 CQAS 출처 이력을 갱신하여 모든 생성 아티팩트가 동일한 권위 있는 소스 digest를 유지하게 합니다. Digest만 갱신해도 런타임 권한은 바뀌지 않습니다.
