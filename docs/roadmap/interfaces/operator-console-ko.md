...
translation_source_sha: c62ecb4a33e4fd81e06d959cb7e3a327e1f1bdf2
...
태그 수정 canary는 Console의 변경 표면 밖에 유지됩니다. Console은 ActionType 모드,
사람 승인, 전달, rollback 및 독립적으로 확인된 효과 기록을 표시할 수 있지만 대상을 선택하거나
태그 값을 제공하거나 ActionType을 승격하거나 개발 operations gateway를 호출할 수 없습니다.
이러한 전이는 형식이 지정된 제어 루프와 배포 경로를 계속 사용합니다.
