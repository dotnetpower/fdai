...
translation_source_sha: 47d02385899682850234538f70d5f677b86035f2
...
영역별 성과 화면은 귀속 정보가 누락되어도 복원력, 변경 안전, 비용 거버넌스를 계속 표시합니다. 누락된 값은 근거 없음으로 표시하며, 측정 구간에 비용 이벤트가 한 건 이상 관측된 경우에만 절감액 0을 표시합니다.
