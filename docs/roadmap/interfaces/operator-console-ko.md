...
translation_source_sha: 9ef7e0979ad6eb7ae544c6a32f23417a43da2a37
...
명시적으로 선택한 Sample 모드는 일반적인 읽기 전용 실행 예시 3건을 제공합니다. 빈 Live 소스를 대체하거나 허용된 상태 전환을 제공하지 않습니다. 같은 본문 폭의 시안 비교, 키보드 조작, 밝은·어두운 테마의 상태 글자 대비, 320-1440px 화면 재배치 검사가 이 표현을 검증합니다.
