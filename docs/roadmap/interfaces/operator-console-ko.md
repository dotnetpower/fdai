...
translation_source_sha: fe16fb8887327a791ad2bc083f3a45b560a0af90
...
| System Knowledge 역할 카탈로그 | 재생성은 인용된 Pantheon bus ownership 및 구독 사실을 갱신할 수 있으며 graph lifecycle ownership은 별도로 유지됩니다. Console 데이터 원본, AKS 시나리오 동작, 사람 보고 체계, 승인 경로 또는 실행 권한은 변경하지 않습니다. |
