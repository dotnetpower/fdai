...
translation_source_sha: c57bc0f5242e16e84159fa1d74b876866d0c2017
...
지식 > 문서는 새로 고친 뒤 컬렉션 범위가 적용된 문서 목록을 제한된 개수로 복원합니다.
컬렉션을 바꾸면 다음 권한 적용 읽기 전에 이전 행을 지우며, 문서나 컬렉션 권한을 부여하지
않고 로딩, 사용 불가, 오류, 빈 상태를 서로 구분합니다.
