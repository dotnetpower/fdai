...
translation_source_sha: e0d9753c52707a2734ca22c3639301eeaeb08b06
...
실행 권한을 부여하지 않습니다.
Core에 패키징된 개발 진단 모듈은 명시적으로 활성화된 로컬 소유자 전용 Unix 소켓만 제공하며 Console, Operator HTTP 또는 권한 경로를 추가하지 않습니다.
