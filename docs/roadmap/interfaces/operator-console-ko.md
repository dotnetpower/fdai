...
translation_source_sha: f27c1ffd8ad0604ad787639c8f2b9d370c9e096e
...
운영 화면은 프로비저닝 목업의 실행 요약을 따르고 단계, 준비 상태, 리소스를 키보드로 조작할 수 있는 보기로 구분하되 목업 전용 수명 주기 데이터는 복사하지 않습니다.
