...
translation_source_sha: d1a3efe90b05885ea706d8fb30b5b8c6fff8e3e8
...
영역별 성과 및 운영 성과 화면은 귀속 정보가 누락되어도 영역 행을 유지하고 정식 관측 이벤트 분모를 보존하며, 스키마 버전이 있는 전송 계약을 통해 근거 없음과 측정된 0을 구분합니다. 측정 구간에 비용 이벤트가 한 건 이상 관측된 경우에만 절감액 0을 표시합니다.
