...
translation_source_sha: c15c746250473f740ba26f21d2f05f10f690f71f
...
Console은 Core가 제공한 버전 2 의도 근거만 수락하며 정확한 개정 인용과 불완전한 범위의 한계를 표시합니다. 문서 텍스트를 지시나 현재 운영 상태로 취급하지 않습니다. 커밋된 의미 의도 범위 산출물은 원본 통합 뒤에 다시 생성하고 정확한 통합 질문 은행 다이제스트에 결속하며 런타임 권한을 부여하지 않습니다.
