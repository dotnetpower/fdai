...
translation_source_sha: 9f6b14a5c1799781c65410341f502e1496066580
...
영역별 성과 및 운영 성과 화면은 귀속 정보가 누락되어도 영역 행을 유지하고 정식 관측 이벤트 분모를 보존합니다. 누락된 값은 근거 없음으로 표시하며, 측정 구간에 비용 이벤트가 한 건 이상 관측된 경우에만 절감액 0을 표시합니다.
