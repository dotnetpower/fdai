...
translation_source_sha: 2a13e7b4d266c9ef76d87a558ea00ced74f14aa3
...
운영 화면은 소스 안내에 보이는 제목을 사용하고 프로비저닝 목업의 실행 요약을 따르며, 단계, 준비 상태, 리소스를 키보드로 조작할 수 있는 보기로 구분하되 목업 전용 수명 주기 데이터는 복사하지 않습니다.
