...
translation_source_sha: a7b0d5fd3be182b97f0ec3673147f3cef8593b92
...
Settings > Runtime policies에서는 Owner가 적극적인 T2 답변 복구를 제어할 수 있습니다. 개발
환경에서는 기본적으로 활성화하고, 스테이징과 운영 환경에서는 승격 근거를 확보할 때까지
비활성화합니다. 감사되는 리비전을 저장하면 Core를 재시작하지 않고 이후 대화형 읽기 턴에 적용됩니다.
이 컨트롤은 Golden 캠페인, 액션 초안, 범위 또는 권한 부여 차단, 실행 경로에서 T2를 활성화할 수
없으며 온톨로지 또는 근거 검증을 완화하지 않습니다.
