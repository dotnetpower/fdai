...
translation_source_sha: db63b61301921087d2135168c6629bd0410d973b
...
대시보드는 로딩, 부분 완료 및 사용 불가 상태에서도 범위가 제한된 서비스 상태 답변을 보존합니다. 일반 인벤토리 데이터로 대체하지 않고 의미 변환 결과의 정확한 리소스 식별자, 근거 시각 및 공급자 제한을 표시합니다.
