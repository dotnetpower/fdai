...
translation_source_sha: c9ae179318dbbf52e4149f27f60821a01f4c5073
...
탐색 전체를 다시 시작합니다. 처음 불러올 때는 하나의 전체 제한 시간 안에서 범위가 제한된 지수형
지연을 사용합니다. 이후 주기 또는 스트림이 일으킨 전환에서는 마지막으로 완료된 화면을 유지하고
근거를 오류 화면으로 바꾸는 대신 새로 고침이 지연됨을 표시합니다.
