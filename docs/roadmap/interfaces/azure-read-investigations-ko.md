...
translation_source_sha: 0072fc0c16df8505c82c35a3fd8429ab8a842d58
...
| Planner intent coverage | 구현됨 | Runtime intent에 server-owned default evidence plan이 없으면 import 및 exhaustive test가 실패하므로 request 시점의 늦은 key error를 방지합니다. |
