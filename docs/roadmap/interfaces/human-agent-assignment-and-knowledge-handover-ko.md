...
translation_source_sha: 11b2bd3629c293ded7b66a5e6e4a9bce3e714cbb
...
> 있는 임무, 통합 할당 케이스 코어가 있습니다. 케이스 코어는 관찰 전용이며 변경 불가능한 의도,
> 정규화된 검토 정족수, 리비전 기반 상태, 결과 영수증, 활성화 선행조건을 검증합니다. Entra 그룹
> 자동 변경, Assignments API와 콘솔, 사람 무응답 감독자, 선제적 인수인계 목표는 아직 구현되지
> 않았습니다.
>
