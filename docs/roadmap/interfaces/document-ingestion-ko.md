...
translation_source_sha: 031447e0a1fc071e93a8c4872358d004bbfc0132
...
| 대체된 버전 정리 실패 | 원본 리비전마다 멱등적인 취소 행 하나를 유지합니다. 각 커넥터 요청은 범위가 제한된 페이지를 처리하고, 새 원본 이벤트가 없어도 API 백그라운드 조정기가 범위가 제한된 원본 항목 페이지를 재시도합니다. |
