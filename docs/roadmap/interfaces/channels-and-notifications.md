...
| Teams, Slack, and outbound notification adapters | in-progress | [`teams_adapter.py`](../../../services/core-control-plane/src/fdai/delivery/chatops/teams_adapter.py), [`slack.py`](../../../services/core-control-plane/src/fdai/delivery/notifications/slack.py), [`slack_transport.py`](../../../services/core-control-plane/src/fdai/delivery/channels/slack_transport.py), [`test_teams_adapter.py`](../../../services/core-control-plane/tests/chatops/test_teams_adapter.py), [`test_adapters.py`](../../../services/core-control-plane/tests/notifications/test_adapters.py), [`test_slack_transport.py`](../../../services/core-control-plane/tests/delivery/channels/test_slack_transport.py) | Teams implements `HilChannel`, Slack implements an uncomposed production A3 transport, and the A2/A4 notification adapters pass focused tests. No Slack `HilChannel`, A1 callback, Entra re-authentication flow, Teams A3 transport, or production A3 runtime is present. |
