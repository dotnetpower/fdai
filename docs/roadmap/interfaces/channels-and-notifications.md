...
| Agent activity | Block Kit sections in handoff, plain-text command/result, Bragi-answer order | Adaptive Card blocks in the same order | Bounded text with the same agent attribution and redaction markers |
