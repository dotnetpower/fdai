...
translation_source_sha: f466ddc675148effc63acd131b150b472606eb84
...
- **배포 주기:** FDAI 설계와 구현 지식은 운영 컨트롤 플레인을 다시 배포하지 않고 갱신할 수
  ...
  수정하면 검색 또는 권한을 바꾸지 않고 해당 레코드 다이제스트를 갱신합니다.
...
인용한 blob 신원은 바뀝니다. 이 기계적 갱신은 Pantheon 귀속 지침과 CI에서 검증한 보정을 포함한 수정 원본 식별자를
