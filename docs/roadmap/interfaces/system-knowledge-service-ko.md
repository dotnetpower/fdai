...
translation_source_sha: acc711954709b9d7315457893fd87ddf454d0f16
...
콘솔 복원력 원본 개정에도 같은 규칙을 적용합니다. 재시도와 로딩 표시 변경은 원본 blob
고정값과 카탈로그 다이제스트만 갱신하며 카탈로그 내용, 검색, 메시지 전달 또는 권한 범위를
넓히지 않습니다.
