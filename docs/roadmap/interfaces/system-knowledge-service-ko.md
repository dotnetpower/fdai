...
translation_source_sha: 9ee13667f44841bc24ad4b71f4782d56d523b1c1
...
카탈로그를 다시 빌드해야 blob 고정값과 다이제스트가 release 트리와 일치합니다. 이 기계적 갱신은 Pantheon 귀속 지침과 CI에서 검증한 보정을 포함한 수정 원본 식별자를
