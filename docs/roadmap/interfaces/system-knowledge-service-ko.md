...
translation_source_sha: e6659c9c66bfdf9557afeaa685c807a783507638
...
카탈로그를 다시 빌드해야 blob 고정값과 다이제스트가 release 트리와 일치합니다. 이 기계적 갱신은 Pantheon 귀속 지침을 포함한 수정 원본 식별자를
