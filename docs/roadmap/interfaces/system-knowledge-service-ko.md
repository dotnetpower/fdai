...
translation_source_sha: a4283e00f856d934f38d97bcbd109136e7ee91ff
...
- **Release 고정 카탈로그:** build 명령은 추적되는 파일에서 구조화 레코드와 소스 인용을
  ...
  않습니다.
- **설명 전용 경계:** 다시 빌드한 카탈로그는 중복 Event 처리, Event 시각 구간, 범위가 제한된
  재발 신원처럼 개정된 에이전트 보장을 제공할 수 있지만, 해당 보장을 집행하거나 Event 처리에
  참여할 수 없습니다.
