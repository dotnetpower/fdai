...
| 2026-08-17 | in-progress | Ran the immutable strict gate twice on centrally validated source `e1e6293f0db3fa3fdd0b950eff69695331d50060`. Both runs retained 14 live and zero resumed judgments with one generation, zero retries, zero ambient or incident-bound requests, zero unsupported claims, and zero unauthorized execution. The first retained 11 evidence-complete answers and the second retained 10; only `ko-property_filter-5` repeated as unsupported. Provider and query-node failures remained zero, so the residual defect was plan-field variation rather than transport or provider failure. | [Issue #63](https://github.com/dotnetpower/fdai/issues/63); runs `issue63-e1e6293f0-20260817T055659Z` and `issue63-e1e6293f0-r2-20260817T061558Z`; exact source has a successful central receipt. | Keep the strict gate blocked and the seeded cohort stopped. Centrally validate frame v8 and plan v10, then rerun the unchanged strict cohort. |
