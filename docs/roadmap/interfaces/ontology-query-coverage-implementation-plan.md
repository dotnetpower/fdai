...
- [ ] Complete a separate 7/7 exact-target Container Apps follow-up receipt. It should prove typed
  ingress projection, bounded seven-day activity, official `MemoryPercentage` semantics, and
  deterministic causal completion without generic ObjectSet substitution.
