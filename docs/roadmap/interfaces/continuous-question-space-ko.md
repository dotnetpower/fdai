...
translation_source_sha: 0041e147e0934610170da8ab982d9fc1cec23070
...
| 날짜 | 상태 | 변경 | 근거 | 남은 작업 |
|------|------|------|------|-----------|
| 2026-09-16 | implemented | 최신 이중 언어 Console 카탈로그 변경을 통합한 뒤 통합 질문은행과 CQAS 출처 이력을 다시 생성했습니다. 질문 400개의 신원, 문구, 준비 상태, 지표, 분모 및 권한 필드는 바뀌지 않았습니다. | `current change`; 공식 질문은행 및 의미 의도 생성기, 질문은행, Golden 데이터 세트 및 의미 의도 산출물 집중 검사 23개 통과. | 의미, 런타임 연결, 근거 또는 권한 동작은 바뀌지 않았습니다. |
