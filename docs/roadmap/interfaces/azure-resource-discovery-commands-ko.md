...
translation_source_sha: ae242bf7b6f1fadab38a40ab617677faaddc39ce
...
프로필 리비전 `1.2.0`과 카나리 기록기는 Azure CLI `2.89.1` 기준을 공유합니다. 보존된 근거를
검증할 수 있도록 과거 `1.1.0` 프로필도 재구성할 수 있습니다. `--validate`는 과거 무결성만
