...
translation_source_sha: c36f2f85a48adf24db74a63a4c9c7af0ec5e3b5d
...
분류하지 않으며 자연어를 쓰기 엔드포인트에 직접 보내지 않습니다. 타입이 지정된
`resource_identity` 요구 사항 하나만 있으면 정확한 리소스 이름 또는 ID를 요청하는 locale별
