...
translation_source_sha: 39daae3cff6a2a2930c9ca3071c18bb55732532e
...
[검색 적격성 설계](../rules-and-detection/rule-semantic-retrieval-ko.md)는 이제 설정된 집단이 빠지면 평가기 자체가 보류하도록 요구합니다. 모든 집단이 있다는 사실만으로 충분한 표본 수나 실제 임베딩 관련성이 입증되지는 않습니다.
