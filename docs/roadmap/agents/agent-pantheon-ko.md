...
translation_source_sha: a7c21fbd9f79a9c2f17537799097a625d064a596
...
반복 Event 에피소드에서는 비어 있지 않은 각 Event `idempotency_key`를 한 번만 계산하므로, at-least-once 전달만으로 Heimdall 임계값이 증가하거나 중복 근거에서 Incident 후보가 생성되지 않습니다.
