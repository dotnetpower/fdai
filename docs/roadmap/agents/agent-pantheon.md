...
routing. Unknown A2A requester or target names are rejected; only the correlation trace crosses ports, and responses receive the same owner, size, and sensitivity normalization as operator answers.
