...
Only events from one correlation episode repeated inside the configured rate window form that
anomaly; sparse samples and independent episodes never combine. A routine heartbeat,
