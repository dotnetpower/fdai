...
| Forseti | Judge | 2 | Verdict, RCA, SecurityEvent, ArbitrationRequest | produces verdicts; optional planned-change graph context is accepted only as a typed evidence receipt and can only lower autonomy; no executor role | yes (T2 abstain only) |
