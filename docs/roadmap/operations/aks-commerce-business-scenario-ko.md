...
translation_source_sha: 6f05551deac4331794cc2edf3c34a510e324bffd
...
확인 기록 발급, 신뢰 상태 갱신 및 분리된 데이터베이스 권한은 배포에서 관리합니다.
...
독립된 확인 기록 발급자, 인증된 시험 주문 수집, 신뢰 수명 주기, 최소 데이터베이스 권한 및
작업 예약은 배포에서 제공해야 합니다. 명령 설치만으로 실제 관측 루프가 성립하지는 않습니다.
