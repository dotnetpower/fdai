...
The package exposes one bounded analytics command to the local coordinator and deployed scheduled job. Its durable run receipt and read projection report freshness and source readiness; they do not enable the package, create a case, or grant approval, execution, or promotion authority.
