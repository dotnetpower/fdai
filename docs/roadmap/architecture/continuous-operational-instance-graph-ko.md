...
translation_source_sha: 0500346620b29565b6641420764b004a8bac6f7d
...
게시 시 저장된 내용을 다시 검증하고 기존 활성 세대, 수정 번호, 끝점 및 다중성 검사를 유지하며, 준비 참조를 그래프와 상태 변경에 함께 기록합니다. 여전히 기존 잠금 안에서 그래프 행을 교체하므로 짧은 포인터 전환 트랜잭션은 아닙니다.
