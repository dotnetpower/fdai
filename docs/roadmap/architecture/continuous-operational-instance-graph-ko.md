...
translation_source_sha: fe25645b3adc06defa6e72dcddeadc9d0c7d161d
...
관측 구간, 커버리지 및 의존 버전을 고정합니다. 조회와 페이지 이동은 검증된 파티션 버전 집합 하나를 고정하며 각 파티션의 최신값을 임의로 섞지 않습니다. 부분 후보는 완전한 활성
소유 집합을 교체하지 않습니다.
