...
translation_source_sha: 04f9c19142653160cc5525b2f5bd953b4874991c
...
추가형 마이그레이션은 기존 행을 단일 트랜잭션에서 채웁니다. 테이블 잠금을 유지하면서
업데이트 보호 장치만 일시 중지하고 `NOT NULL` 제약 조건을 적용하기 전에 복원합니다. 삭제
보호 장치는 계속 활성 상태로 둡니다.
