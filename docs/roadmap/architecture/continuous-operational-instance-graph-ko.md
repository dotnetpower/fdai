...
translation_source_sha: 930badfa0102d512731cb951396712827b390412
...
ARM ID와 대소문자 구분 없이 일치해야 합니다. 알려진 자식 작업이 부모 ARM ID에만 연결되어
보고되면 누락된 자식 ID를 안전하게 재구성할 수 없으므로 해당 행을 건너뜁니다. 그 밖의 모순이
있으면 범위가 제한된 수집을 실패시키고 이전의 완전한 세대를 유지합니다.
