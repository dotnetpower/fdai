...
translation_source_sha: 2dbb4fc7cbcef4a83be919e69dfe62137de3db3c
...
- **배포 근거:** 보호된 플랫폼 계획 메타데이터는 전용 저장소 모듈에서 생성합니다. 워크플로
  ...
  없습니다. 상태를 재정의하는 서비스 배포 아티팩트 작업은 보호된 원본 검증기가 성공한
  후에만 실행합니다. 정리 또는 아티팩트 보존은 디스패치를 관측 근거로 바꾸지 않습니다.
