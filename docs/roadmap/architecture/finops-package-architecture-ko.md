...
translation_source_sha: 36ff0148cee026672503af26f54c4513046d9daf
...
> Terraform deployer 역할은 구성된 안정 실행기 UAMI principal을 사용합니다. 실행기 호스트를
> 교체해도 패키지 또는 관찰 권한은 바뀌지 않습니다.
