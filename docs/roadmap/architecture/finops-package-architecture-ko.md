...
translation_source_sha: a229ad5267134504d83829dd0a4f80ae778897dd
...
> 고정 대화 품질 보증 시나리오 사실도 공유 읽기 전용 Pantheon 숙의 경로의 진단 전용 입력으로
> 유지됩니다. 이 사실은 Cost Governance를 설치, 활성화, 구성 또는 게시할 수 없고 데이터 접근이나
> 작업 권한도 부여할 수 없습니다.
