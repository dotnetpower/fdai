...
translation_source_sha: 6f3120194a39e1ae5d46658843bbc55b253d7283
...
브라우저 근거 v2 읽기 경로와 경로 전용 카탈로그도 마찬가지로 호스트가 소유합니다. 패키지
프로바이더를 가져오거나 비용 거버넌스 경로, 데이터, 활성화 또는 권한을 변경하지 않습니다.
...
상태를 주장하지 않고 사용 가능한 facet만 표시할 수 있습니다. Operator HTTP surface 선택은 정확한
canonical enum 값만 비교하며 자연어를 해석하지 않습니다. 두 경로 모두 패키지를 활성화하거나
