...
| Provider-native unclassified identities | implemented | [`inventory.py`](../../../services/core-control-plane/src/fdai/shared/providers/inventory.py), [`arg_query.py`](../../../services/core-control-plane/src/fdai/delivery/azure/arg_query.py), and focused checks (`259 passed`) | A reviewed reserved ResourceType keeps unsupported provider identities visible without inventing type-specific semantics. Live projection evidence remains open. |
