...
- [x] Supply and verify graph-freshness authority for planned-change assessment before allowing any automated clearance. Focused checks cover stale, incomplete, conflicting, mixed-release,
  target-mismatched, future, truncated, pending-overlay, and unavailable cases.
