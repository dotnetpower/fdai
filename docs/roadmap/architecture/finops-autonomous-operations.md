...
> Hardening rounds 1-5 reject mixed campaigns and option substitution, verify Azure auth, bound memory, and preserve component-wise disclosure; no runtime authority changes.
