...
translation_source_sha: 66a52137d90b81674bb803d5957282bc21f1842f
...
| 발행기 한정 Foundry 카탈로그, 인프라 및 endpoint 계약 | implemented | Resolver, `infra/modules/llm/foundry-partner/`, runtime endpoint resolver, 집중 검사 | Root Terraform은 발행기와 private networking을 분리합니다. Runtime은 엄격한 OpenAI/Foundry endpoint 참조와 API style을 받습니다. 봉인된 binding 생성과 registry 활성화는 미완료 상태입니다. |
...
호환됩니다. Root Terraform은 발행기를 분리하고 private partner resource를 조건부로 조립합니다. Runtime은 엄격한 OpenAI/Foundry account 참조를 해석하며 봉인된 binding 생성과 registry 활성화는 미완료 상태입니다.
