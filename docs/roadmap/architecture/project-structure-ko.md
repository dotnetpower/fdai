...
translation_source_sha: af9452658a235b036dff860329b94c645a46f2e3
...
| Rule / 정책 출처 | rule-catalog + `policies/` 로더, `RuleIndex`, `CatalogIndexLifecycle` | - | lock된 원자적 current/N-1 전달 인덱스를 사용하는 번들 범용 규칙; 보존된 버전의 충돌은 거부 | 고객 규칙 세트 / 임계값 |
