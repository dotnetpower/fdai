...
translation_source_sha: 0624607986ce7d854d95d8d9dcff3a3277fee2c3
...
| Rule / 정책 출처 | rule-catalog + `policies/` 로더, `RuleIndex`, `CatalogIndexLifecycle` | - | 잠금으로 보호되는 원자적 current/N-1 전달 인덱스를 사용하는 번들 범용 규칙. 보존된 버전이 충돌하면 차단합니다. | 고객 규칙 세트 / 임계값 |
