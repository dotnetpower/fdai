...
translation_source_sha: 2f3fadd29c6849bac1eb38df5a0bb803662c9827
...
│   │   ├── kubernetes/         # evaluation 및 runtime evidence가 공유하는 exact quantity, bounded projection 및 hold-only capacity/dependency/admission-drift finding
