...
translation_source_sha: 964f439b090026952cfaf2b2f7537e2824dc13f9
...
클라우드 변경 비교는 원문과 처리 식별자를 검증하며 Core는 출처와 기존 인용문 예산을 재검증합니다. 문서 검색 스키마 업그레이드는 기능 존재만이 아니라 정확한 카탈로그 소유 프롬프트 계층도 요구합니다.
