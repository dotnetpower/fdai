...
translation_source_sha: 2bfe5ddd0173f8891347b3decaed7a8da604be51
...
│   │   ├── kubernetes/         # evaluation 및 runtime evidence가 공유하는 exact quantity, bounded projection 및 hold-only capacity/endpoint-dependency finding
