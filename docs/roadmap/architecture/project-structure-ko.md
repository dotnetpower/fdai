...
translation_source_sha: d915bef7200469a967d3a88f01075b6746df4d49
...
- **자격 검증 축약에는 권한이 없음**:
  ...
  시도한 사례 ID의 순서와 판단 보류 사례 ID만 보존하므로, 이후 명시적 캠페인은 질문 내용을
  저장하거나 라이브 요청을 재시도하지 않고 이전 시도를 제외할 수 있습니다. 일반
