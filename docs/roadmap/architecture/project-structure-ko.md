...
translation_source_sha: d351e68627b0332f291f6fb71aa71d4e2aac29fa
...
│   │   ├── ontology_platform/   # exact release, semantic interface, bounded object set, secured purpose/ACL query receipt, shared exact-number property semantics, immutable diagnostic ledger/result projection, mutation plan, typed function, authenticated reconciliation과 proposal-only terminal outbox, proposal-only SDK generation
