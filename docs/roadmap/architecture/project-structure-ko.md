...
translation_source_sha: 507f40467d2459b488ad1bbc44ecfe69057ca903
...
## 모듈 경계(모듈 Boundaries)
[알림 과다 수신 관리](../operations/alert-noise-governance-ko.md)가 타입 지정 근거, Process와 조건부 수동 PR을 소유합니다. 전용 Operator 조립은 변환 결과, 선호 설정, 이력과 감독되는 브리지 하나를 연결하며 공통 루트는 수명 주기만 소유합니다. 공유 근거 수락 목록이 기록과 Workflow 승격 결정의 검증 경계를 고정합니다. 카탈로그 테스트는 채택되지 않은 R7이 아닌 현재 계약을 따르며 생성/오프라인 근거는 권한이나 운영 인증을 부여하지 않습니다.
