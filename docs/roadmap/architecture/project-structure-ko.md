...
translation_source_sha: 696c3f48e1455d4783980d12e9c61e25f5eda32c
...
- **독립 효과 관측**: 영속 kinetic artifact 저장소가 exact-plan source입니다.
  `StateStoreExecutedActionObservationStore`는 검증기가 승인한 Heimdall 관측만 받습니다. 연결되지 않은
  `StateStoreShadowReversionWriter`는 현재 승인을 요구하며 ActionType 하나만 복귀시킵니다.
