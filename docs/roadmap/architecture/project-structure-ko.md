...
translation_source_sha: d023a5757da3e3a3730142eb0797b50b946ec1a3
...
| Rule / 정책 출처 | rule-catalog + `policies/` 로더, `RuleIndex`, `CatalogIndexLifecycle` | - | lock된 원자적 current/N-1 전달 인덱스를 사용하는 번들 범용 규칙; digest tombstone이 제거된 버전의 충돌을 거부 | 고객 규칙 세트 / 임계값 |
