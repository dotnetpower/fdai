...
translation_source_sha: 16e6b63916db808fd4acbb54b55f6dea4377cb10
...
- 리포 루트에 **하나의 lockfile** (`uv.lock` 또는 동등물)을 두고 루트 `pyproject.toml`은
  ...
  소스 체크아웃 호환성 검사는 서비스 코덱을 가져오기 전에 `packages/runtime-diagnostics/src/`를 포함하여 선언된 모든 공유 패키지 소스 루트를 추가합니다.
