...
translation_source_sha: 0b2723fdd3610fbb2fa5dc066a18e754b173bf6b
...
- **콘솔에는 privileged 신원이 없음**: 상태, 감사, shadow 결과, HIL 큐를 시각화합니다. 접근 권한은
  ...
  정상 6시간 검사 간격을 유지하되, 관측된 변경이 하한을 넘어 아직 조정되지 않았으면 앞당겨
  조정하며 newer 실패한/abandoned 시도는 다음 틱에 재시도합니다. 로컬 실행 장치는
  Azure 발견을 실행하지 않습니다.
