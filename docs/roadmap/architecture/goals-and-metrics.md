...
- [ ] Adopt `DecisionCriticalEvidenceReceipt` at every readiness, query, state, promotion, and qualification decision boundary, then prove synthetic or incomplete evidence cannot satisfy a live claim.
