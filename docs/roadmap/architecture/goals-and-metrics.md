...
- [x] Complete SRE `cross_objective_conflict` with scenario-produced competing options audited through the shipped Forseti-to-Odin arbitration boundary. Evidence: `services/core-control-plane/tests/scenarios/cross-objective/v2026.07-sre.json` and the three focused conflict tests in `test_v2026_07_replay.py`.
