...
| State | Count | Meaning |
|-------|-------|---------|
| Completed | 7 | SD-00 through SD-06 have recorded exit evidence and focused validation. |
| In progress | 1 | SD-07 has a healthy live shadow deployment; its image-admission hardening handoff remains active. |
