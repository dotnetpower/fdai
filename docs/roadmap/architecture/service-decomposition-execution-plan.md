...
| 2026-08-09 | IS-07 | Completed locally | Local transition evidence | Five `0.1.2 -> 0.1.1 -> 0.1.2` wheel transitions, ten nonroot service images, and ten peer-stable focused migration/rollback receipts passed with preserved offsets, zero peer restarts, and zero duplicate terminal effects. Remote rolling confirmation remains deferred to IS-09. |
