...
translation_source_sha: 6780b233a02532c45150f8455f5dc7171e0d6173
...
> 강등시킵니다. 이제 교차 권위 판정은 변환된 프로바이더 상태를 독립 텔레메트리와 비교하면서
> 각 출처의 권한, 범위, 기준 시점, 최신성, 완전성 및 출처 이력을 보존합니다. 일치, 텔레메트리
> 누락, 오래된 변환 결과, 오래된 텔레메트리, 충돌 및 검열은 서로 다른 결과로 유지됩니다.
> 충돌 시 경합 중인 값을 제외하고 읽기 신뢰도를 낮추며 변경 또는 실행 권한을 제공하지 않습니다.
