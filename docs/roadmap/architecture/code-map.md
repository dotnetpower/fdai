...
| tiers/t2_reasoning | Frontier-model reasoning (novel cases only), bounded per event by the declared call budget and escalating to HIL when it is spent; the money limb lives at the metering write, which is the only place the pipeline observes cost | [src/fdai/core/tiers/t2_reasoning/](../../../src/fdai/core/tiers/t2_reasoning/) | [tests/core/tiers/](../../../tests/core/tiers/) | [llm-strategy.md](llm-strategy.md) |
...
| risk_gate | Unified auto vs HIL vs deny authority. Ceiling overrides render Rego, so every interpolated field is pattern-bound and escaped - a request MUST NOT be able to write policy. | [src/fdai/core/risk_gate/](../../../src/fdai/core/risk_gate/) | [tests/core/risk_gate/](../../../tests/core/risk_gate/) | [decisioning/](../decisioning/) |
| hil_resume | Park + resume on human decision. Principal identities compare case-insensitively, so recasing an object id cannot present one person as two and defeat the no-self-approval floor. With no-drop load plans, one-per-group initial dispatch, atomic expiry reaping, bounded reminders, and durable decision-delivery recovery | [src/fdai/core/hil_resume/](../../../src/fdai/core/hil_resume/), [hil_registry.py](../../../src/fdai/shared/providers/hil_registry.py), and [hil_decision.py](../../../src/fdai/delivery/chatops/hil_decision.py) | [tests/core/hil_resume/](../../../tests/core/hil_resume/), [test_hil_callback.py](../../../tests/delivery/read_api/test_hil_callback.py), and [test_hil_decision.py](../../../tests/delivery/test_hil_decision.py) | [channels-and-notifications.md](../interfaces/channels-and-notifications.md) |
| executor | Per-resource lock, idempotent apply, and one shared blast-radius ceiling for all three execution paths - an action that declares no affected count is refused, not waved through | [src/fdai/core/executor/](../../../src/fdai/core/executor/) | [tests/core/](../../../tests/core/) (executor tests) | project-structure.md |
...
| case_history | Canonical case revisions, StateStore-to-PostgreSQL shadow migration, full-chain backfill, retention, governed Norns analysis, and the planned operational-case learning projection ([case-history design](../rules-and-detection/prediction-learning-and-case-history.md), [operational-learning design](../rules-and-detection/operational-learning-ontology.md)) | [src/fdai/core/case_history/](../../../src/fdai/core/case_history/), [src/fdai/shared/providers/case_history.py](../../../src/fdai/shared/providers/case_history.py), and [src/fdai/delivery/persistence/](../../../src/fdai/delivery/persistence/) | [tests/core/case_history/](../../../tests/core/case_history/), [tests/persistence/test_case_history_backfill.py](../../../tests/persistence/test_case_history_backfill.py), [tests/persistence/test_postgres_case_history.py](../../../tests/persistence/test_postgres_case_history.py), and [tests/agents/test_forecast_learning_chain.py](../../../tests/agents/test_forecast_learning_chain.py) |
| rca | Root-cause analysis plus leakage-safe lagged correlation evidence capped at predictive precedence | [src/fdai/core/rca/](../../../src/fdai/core/rca/) | [tests/core/rca/](../../../tests/core/rca/) |
...
| read_investigation | Verified typed current/activity resource queries, observed-facet deterministic compilation, exact-resource follow-ups, 30-day Activity Log history, bounded parallel evidence, RG-scoped subscription health, durable latency profiles, owner-scoped direct/stream replay, honest cost usage, SSE heartbeats, and stream-close cancellation ([design](../interfaces/azure-read-investigations.md)) | [src/fdai/core/read_investigation/](../../../src/fdai/core/read_investigation/), [chat_inventory_query.py](../../../src/fdai/delivery/read_api/routes/chat_inventory_query.py), [chat_inventory_compiler.py](../../../src/fdai/delivery/read_api/routes/chat_inventory_compiler.py), [chat_inventory_activity.py](../../../src/fdai/delivery/read_api/routes/chat_inventory_activity.py), [chat_resource_context.py](../../../src/fdai/delivery/read_api/routes/chat_resource_context.py), and [src/fdai/delivery/azure/read_investigation/](../../../src/fdai/delivery/azure/read_investigation/) | [tests/core/read_investigation/](../../../tests/core/read_investigation/), [tests/delivery/azure/read_investigation/](../../../tests/delivery/azure/read_investigation/), [test_chat_inventory_query.py](../../../tests/delivery/read_api/test_chat_inventory_query.py), [test_chat_inventory_compiler.py](../../../tests/delivery/read_api/test_chat_inventory_compiler.py), and focused read API/persistence tests |
...
| operational_context | Immutable service/workload/objective graph snapshots with never-raising freshness and conflict ceilings ([design](operating-ontology.md)) | [src/fdai/core/operational_context/](../../../src/fdai/core/operational_context/) | [tests/core/operational_context/](../../../tests/core/operational_context/) |
| decision_case | Shared reliability, ARB, and cost options with protected-objective selection and `ResponseOutcome` closure | [src/fdai/core/decision_case/](../../../src/fdai/core/decision_case/) | [tests/core/decision_case/](../../../tests/core/decision_case/) |
| operational_learning | Balanced positive/negative outcome cohorts compiled into inert Norns candidates | [src/fdai/core/operational_learning/](../../../src/fdai/core/operational_learning/) | [test_norns_operating_pattern.py](../../../tests/agents/test_norns_operating_pattern.py) |
...
| runtime_settings | Allowlisted environment defaults plus revisioned, audited StateStore overrides | [src/fdai/delivery/runtime_settings.py](../../../src/fdai/delivery/runtime_settings.py) and [runtime_settings.py](../../../src/fdai/delivery/read_api/routes/runtime_settings.py) | [test_runtime_settings.py](../../../tests/delivery/test_runtime_settings.py) and [test_runtime_settings.py](../../../tests/delivery/read_api/test_runtime_settings.py) |
...
| rbac | Human RBAC for the read API. Principal identities compare case-insensitively, so a requester cannot approve their own access request under another spelling. | [src/fdai/core/rbac/](../../../src/fdai/core/rbac/) | [tests/core/](../../../tests/core/) |
...
| runtime_bootstrap | Process composition and long-running task orchestration, with configuration, health-server, required-task, task-supervision, main, and shutdown-signal boundaries isolated as lifecycle helpers | [src/fdai/runtime/bootstrap.py](../../../src/fdai/runtime/bootstrap.py) and [src/fdai/runtime/bootstrap_lifecycle.py](../../../src/fdai/runtime/bootstrap_lifecycle.py) | [tests/runtime/test_bootstrap_config.py](../../../tests/runtime/test_bootstrap_config.py) |
...
| assurance_twin | Read-only ontology twin with active/challenger effect models and deterministic no-op/action branch simulation (never executes) | [src/fdai/core/assurance_twin/](../../../src/fdai/core/assurance_twin/) | [tests/assurance_twin/](../../../tests/assurance_twin/) |
...
| workflow | Compile and run version-pinned WorkflowDefinition records. Approval quorums count normalised principals, so one operator cannot meet a quorum under two spellings or approve a step they requested. With principal bindings, Process journal, and projection retry | [src/fdai/core/workflow/](../../../src/fdai/core/workflow/) | [tests/core/workflow/](../../../tests/core/workflow/) |
| scheduler | Create/pause/resume/edit/run-now/cancel lifecycle, cron dispatch, run history, blueprints, and scoped continuations with idempotent lifecycle audit and CAS winner-only expiry audit ([design](../interfaces/scheduled-result-continuations.md)) | [src/fdai/core/scheduler/](../../../src/fdai/core/scheduler/) | [tests/core/scheduler/](../../../tests/core/scheduler/) |
...
| measurement | Phase-4 continuous measurement, including MTTR, DORA, pattern growth, and audit-driven Dynamic challenger learning. Promotion-gate shadow days use observed windows, not wall-clock age | [src/fdai/core/measurement/](../../../src/fdai/core/measurement/) | [tests/core/measurement/](../../../tests/core/measurement/) |
...
| read_api | Console read-only HTTP surface; production optional-service builders plus route-owned chat request, terminal assembly, verification rendering, background, busy-input, skill, and read-investigation payload/execution helpers | [src/fdai/delivery/read_api/](../../../src/fdai/delivery/read_api/), [production/python_tasks.py](../../../src/fdai/delivery/read_api/production/python_tasks.py), [chat_stream_request.py](../../../src/fdai/delivery/read_api/routes/chat_stream_request.py), [chat_stream_setup.py](../../../src/fdai/delivery/read_api/routes/chat_stream_setup.py), [chat_stream_terminal.py](../../../src/fdai/delivery/read_api/routes/chat_stream_terminal.py), [chat_vision_prompt.py](../../../src/fdai/delivery/read_api/routes/chat_vision_prompt.py), [chat_verification_rendering.py](../../../src/fdai/delivery/read_api/routes/chat_verification_rendering.py), [chat_verification_text.py](../../../src/fdai/delivery/read_api/routes/chat_verification_text.py), [read_investigation_payload.py](../../../src/fdai/delivery/read_api/routes/read_investigation_payload.py), and [read_investigation_execution.py](../../../src/fdai/delivery/read_api/routes/read_investigation_execution.py) |
