...
| metering | Usage metering counters and the shared model budget every LLM path is measured against, charged at the single point where an invocation is recorded; totals survive ledger eviction, per-correlation limbs do not, and a failed metering write still charges | [src/fdai/core/metering/](../../../src/fdai/core/metering/) | [tests/core/metering/](../../../tests/core/metering/) |
