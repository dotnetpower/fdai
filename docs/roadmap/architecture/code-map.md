...
| Continuous operational instance graph | Source-to-store ownership for continuous collection, snapshot and overlay promotion, ontology and topology-history projection, graph-first queries, and bounded retention and archive gaps | [owner design](continuous-operational-instance-graph.md), [audit contract](../../../config/continuous-operational-instance-graph-audit.json), [inventory delivery](../../../services/core-control-plane/src/fdai/delivery/), and [ontology platform](../../../services/core-control-plane/src/fdai/core/ontology_platform/) | [audit tests](../../../tests/integration/scripts/test_continuous_operational_instance_graph_audit.py) |
