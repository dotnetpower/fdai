...
| Publisher-qualified model resolution | Backward-compatible catalog and quota seams, SKU-qualified Azure capacity lookup, stable version selection, deterministic capability records, and fail-closed non-Standard handling for legacy quota adapters | [resolver schema](../../../services/core-control-plane/src/fdai/rule_catalog/schema/llm_resolver.py), [resolver CLI](../../../services/core-control-plane/src/fdai/rule_catalog/schema/llm_resolver_cli.py), and [Azure queries](../../../services/core-control-plane/src/fdai/delivery/azure/llm/resolver_queries.py) | [resolver tests](../../../services/core-control-plane/tests/rule_catalog/schema/test_llm_resolver.py) and [Azure query tests](../../../services/core-control-plane/tests/delivery/azure/llm/test_resolver_queries.py) |
