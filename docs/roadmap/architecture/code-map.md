...
| Observation-mode ARB ontology loop | Planned-intent-only typed Huginn Change ingress, exact release-bound context and evidence, bounded copy-on-write scenario, per-key idempotent replay, Forseti-owned observation verdict, Saga audit, and lineage-derived ReviewCase projection that preserves checks during transient holds | [observation loop](../../../services/core-control-plane/src/fdai/core/architecture_review/observation_loop.py), [Forseti binding](../../../services/core-control-plane/src/fdai/agents/forseti.py), and [ARB projection](../../../services/core-control-plane/src/fdai/core/architecture_review/projection.py) | [observation trace tests](../../../services/core-control-plane/tests/core/architecture_review/test_observation_loop.py), [projection tests](../../../services/core-control-plane/tests/core/architecture_review/test_projection.py), and [readiness tests](../../../services/core-control-plane/tests/core/architecture_review/test_readiness.py) |
