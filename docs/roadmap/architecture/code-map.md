...
| assurance_twin | Read-only ontology twin with scalar and graph active/challenger effect models, immutable state trajectories, bounded typed-path propagation, Dynamic invariants, independent outcome closure, and shadow runtime audit (never executes) | [src/fdai/core/assurance_twin/](../../../src/fdai/core/assurance_twin/) | [tests/assurance_twin/](../../../tests/assurance_twin/) |
