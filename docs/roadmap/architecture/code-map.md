...
| Kubernetes rollout evidence | Allowlisted Deployment and Pod observations, exact target selection, issued two-hop ownership evidence, and a pure freshness- and conflict-aware reducer that never claims root cause or execution authority | [Kubernetes inventory source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py), [rollout query](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_queries.py), and [semantic planner](../../../services/core-control-plane/src/fdai/core/conversation/semantic_kubernetes_rollout_planning.py) | [inventory source tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py), [rollout reducer tests](../../../services/core-control-plane/tests/core/ontology_platform/test_kubernetes_rollout_evidence.py), [planner tests](../../../services/core-control-plane/tests/conversation/test_semantic_kubernetes_rollout_planning.py), and [composition tests](../../../services/core-control-plane/tests/composition/test_wire_kubernetes_rollout.py) |
