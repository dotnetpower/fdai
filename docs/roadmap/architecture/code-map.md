...
|------|----------------|--------|-------|
| Kubernetes Resource event history | Explicit exact-cluster, bounded Kubernetes Event reads with selected immutable-UID attribution, normalized event time, content-addressed evidence, independent Azure/Kubernetes family routing, explicit incomplete results, and no raw message, cause, mutation, or execution authority | [FunctionType](../../../services/core-control-plane/src/fdai/core/ontology_platform/resource_event_queries.py), [Kubernetes reader](../../../services/core-control-plane/src/fdai/delivery/kubernetes_resource_event_history.py), [family router](../../../services/core-control-plane/src/fdai/delivery/resource_event_history.py), and [runtime binding](../../../services/core-control-plane/src/fdai/runtime/resource_event_providers.py) | [Kubernetes adapter tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_resource_event_history.py), [router tests](../../../services/core-control-plane/tests/delivery/test_resource_event_history.py), [FunctionType tests](../../../services/core-control-plane/tests/core/ontology_platform/test_resource_event_queries.py), and [runtime tests](../../../services/core-control-plane/tests/runtime/test_resource_health_provider.py) |
...
| Kubernetes workload evidence | Allowlisted Deployment and Pod observations, exact target selection, issued two-hop ownership evidence in both rollout and Pod-owner directions, reviewed immutable-Pod restart-history metrics, and pure freshness- and conflict-aware rollout and recovery reducers that never claim root cause or execution authority | [Kubernetes inventory source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py), [rollout query](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_queries.py), [Pod recovery query](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_pod_recovery_queries.py), and [semantic planners](../../../services/core-control-plane/src/fdai/core/conversation/) | [inventory source tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py), [workload reducer tests](../../../services/core-control-plane/tests/core/ontology_platform/), [planner tests](../../../services/core-control-plane/tests/conversation/), and [composition tests](../../../services/core-control-plane/tests/composition/) |
