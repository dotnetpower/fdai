...
| Ontology safety platform | Exact semantic releases, production Interface catalog compilation, principal-scoped query manifests with deterministic LinkType endpoint sides, verified generic set/order/project/aggregate/function query algebra, bounded dependency-wave execution, mutation plans, independent effect reconciliation, and durable reconciliation records | [ontology_platform](../../../services/core-control-plane/src/fdai/core/ontology_platform/) | [ontology platform tests](../../../services/core-control-plane/tests/core/ontology_platform/) |
| Semantic conversation planning | Whole-turn schema proposals, server-owned frame/plan identity, principal-manifest verification, shadow comparison, deterministic intent graphs, and Console wire projection without execution authority | [conversation](../../../services/core-control-plane/src/fdai/core/conversation/) | [conversation tests](../../../services/core-control-plane/tests/conversation/) |
