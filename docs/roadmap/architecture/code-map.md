...
| isolated_executor | SD-07 durable shadow command validation, injected logical-target locking, earliest-offset EventBus ingress with poison-record dead-lettering, terminal no-effect receipt publication, supervised health, fail-closed production composition, and an opt-in internal Container App with a dedicated no-effect identity. Terraform defaults the app off; live apply, exact-topology smoke, and rollback evidence remain open. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py), [src/fdai/runtime/isolated_executor_lock.py](../../../src/fdai/runtime/isolated_executor_lock.py), [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py), [src/fdai/runtime/isolated_executor_cli.py](../../../src/fdai/runtime/isolated_executor_cli.py), and [infra/modules/isolated-executor/container-app/](../../../infra/modules/isolated-executor/container-app/) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_lock.py](../../../tests/runtime/test_isolated_executor_lock.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py), [tests/runtime/test_isolated_executor_cli.py](../../../tests/runtime/test_isolated_executor_cli.py), [tests/infra/test_isolated_executor_boundary.py](../../../tests/infra/test_isolated_executor_boundary.py), and [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
