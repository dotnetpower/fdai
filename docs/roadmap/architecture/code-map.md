...
| Alert noise governance | [alert_noise](../../../services/core-control-plane/src/fdai/core/detection/alert_noise/), [runtime binding](../../../services/core-control-plane/src/fdai/runtime/alert_noise.py), and [Operator boundary](../../../services/operator-service/src/fdai_operator_service/alert_quality.py) | [Alert core tests](../../../services/core-control-plane/tests/core/detection/alert_noise/) and [Operator tests](../../../services/operator-service/tests/test_alert_quality.py) | [Alert Noise Governance](../operations/alert-noise-governance.md) |
...
| Rule activation generations | [rule_activation](../../../services/core-control-plane/src/fdai/core/rule_activation/) and [runtime binding](../../../services/core-control-plane/src/fdai/runtime/rule_activation.py) | [Rule activation tests](../../../services/core-control-plane/tests/core/rule_activation/) | [Rule Governance](../rules-and-detection/rule-governance.md) |
