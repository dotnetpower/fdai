...
| change_lineage | Immutable replay-stable join from canonical `ChangeRecord` and `ChangeAssessment` through the selected `DecisionCase` option, `Action`, and `ResponseOutcome`. Nested decision and resilience traces preserve rationale, impact, rollback, verification, and recovery. Canonical identity serialization is isolated from aggregate validation while preserving the existing public identity API. A deterministic learning projection remains candidate-only, requires a separately sealed operational case, and is never reusable by itself. The existing GitHub and Azure DevOps `ChangeFeed` adapters pass the same lineage boundary. Identity, target, digest, causal-order, and ambiguous score mismatches are rejected; the lineage grants no execution or promotion authority. | [src/fdai/core/change_lineage/](../../../src/fdai/core/change_lineage/) | [tests/core/change_lineage/](../../../tests/core/change_lineage/) |
...
| ontology_platform | Exact releases, semantic interfaces, bounded ObjectSets with canonical typed predicates, backend-consistent limits, and typed completeness receipts across direct queries and traversals, mutation planning, typed functions, projection and reconciliation, coverage-reporting provider-observed inventory topology projection, proposal-only SDK generation | [src/fdai/core/ontology_platform/](../../../src/fdai/core/ontology_platform/) | [tests/core/ontology_platform/](../../../tests/core/ontology_platform/) |
...
[`followup.py`](../../../src/fdai/delivery/operator_api/application/conversation/capabilities/inventory/followup.py).
...
Measured LLM usage and its server-owned analytical continuation live in [`chat_llm_usage.py`](../../../src/fdai/delivery/operator_api/application/conversation/capabilities/llm_usage.py). The resolver reads `MeteringReader`, emits a bounded `analysis_context` only after terminal verification, and re-runs a period, grouping, or presentation refinement without trusting browser history.
...
and [`busy_input.py`](../../../src/fdai/delivery/operator_api/application/conversation/busy_input.py).
...
JSON and streamed turn lifecycle coordination lives in
[`turn_execution/`](../../../src/fdai/delivery/operator_api/application/conversation/turn_execution/).
The typed services own request preparation, planning, evidence, generation and stream collection,
verification, persistence, metering, and completion. `chat.py` retains JSON authentication,
bounded parsing, status mapping, response delivery, and factory binding. `chat_stream.py` retains
SSE authentication, bounded request transport, status mapping, framing, heartbeat, sequence,
revision, connection-close cancellation, and response construction.
...
| isolated_executor | Versioned shadow and effect receipts, stable-offset EventBus command/receipt transport, logical-target locking, durable idempotency, pre-effect and terminal audit, default-off authority cutover, independent effect probing, supervised health, and an internal Container App. Live exact-plan, effect, and rollback evidence remain open. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py), [src/fdai/runtime/isolated_executor_client.py](../../../src/fdai/runtime/isolated_executor_client.py), [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py), [src/fdai/runtime/isolated_executor_cli.py](../../../src/fdai/runtime/isolated_executor_cli.py), [src/fdai/runtime/executor_authority_probe_cli.py](../../../src/fdai/runtime/executor_authority_probe_cli.py), and [infra/modules/isolated-executor/container-app/](../../../infra/modules/isolated-executor/container-app/) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_lock.py](../../../tests/runtime/test_isolated_executor_lock.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py), [tests/runtime/test_isolated_executor_cli.py](../../../tests/runtime/test_isolated_executor_cli.py), [tests/runtime/test_isolated_executor_effect.py](../../../tests/runtime/test_isolated_executor_effect.py), [tests/runtime/test_executor_authority_probe_cli.py](../../../tests/runtime/test_executor_authority_probe_cli.py), [tests/infra/test_isolated_executor_boundary.py](../../../tests/infra/test_isolated_executor_boundary.py), and [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
| inventory_ontology | Single-writer provider-observed resource subgraph derived from one promoted inventory generation. It pins owned revisions, replaces its own subgraph atomically, retains owned identities for stale deletion, refuses an object owned by another projection, and reports coverage so an empty result is distinguishable from an unobserved one. A failed projection never invalidates the promoted snapshot. | [src/fdai/runtime/inventory_ontology.py](../../../src/fdai/runtime/inventory_ontology.py) and [inventory_projection.py](../../../src/fdai/core/ontology_platform/inventory_projection.py) | [tests/runtime/test_inventory_ontology.py](../../../tests/runtime/test_inventory_ontology.py) and [test_inventory_projection.py](../../../tests/core/ontology_platform/test_inventory_projection.py) |
...
| operator_api | Console read-only HTTP surface; provider-neutral request-local backend routing; concrete Azure and OpenAI-compatible narrator adapters; production optional-service builders plus application-owned chat request preparation, route-owned bounded HTTP parsing, cursor-paged conversation summaries, principal-scoped knowledge-context assembly, projection-owned terminal payloads and bounded timing, trajectory-detail replay, application-owned terminal verification, background, busy-input, skill, and read-investigation helpers | [src/fdai/delivery/operator_api/](../../../src/fdai/delivery/operator_api/), [application/conversation/backend/](../../../src/fdai/delivery/operator_api/application/conversation/backend/), [adapters/conversation/](../../../src/fdai/delivery/operator_api/adapters/conversation/), [application/conversation/request_preparation/](../../../src/fdai/delivery/operator_api/application/conversation/request_preparation/), [application/conversation/verification/](../../../src/fdai/delivery/operator_api/application/conversation/verification/), [user_context_conversations.py](../../../src/fdai/delivery/operator_api/routes/user_context_conversations.py), [production/knowledge_context.py](../../../src/fdai/delivery/operator_api/production/knowledge_context.py), [production/python_tasks.py](../../../src/fdai/delivery/operator_api/production/python_tasks.py), [chat_knowledge_context.py](../../../src/fdai/delivery/operator_api/application/conversation/capabilities/knowledge_context.py), [chat_stream_request.py](../../../src/fdai/delivery/operator_api/routes/chat_stream_request.py), [projections/conversation/terminal/](../../../src/fdai/delivery/operator_api/projections/conversation/terminal/), [trajectory.py](../../../src/fdai/delivery/operator_api/projections/conversation/trajectory.py), [chat_vision_prompt.py](../../../src/fdai/delivery/operator_api/application/conversation/vision_prompt.py), [read_investigation_payload.py](../../../src/fdai/delivery/operator_api/routes/read_investigation_payload.py), and [read_investigation_execution.py](../../../src/fdai/delivery/operator_api/routes/read_investigation_execution.py) |
...
|---------|---------|--------|
| contracts | Cross-package Pydantic contracts, including versioned isolated-Executor commands and terminal shadow receipts that cannot claim an applied effect | [src/fdai/shared/contracts/](../../../src/fdai/shared/contracts/) |
...
| [src/fdai/delivery/catalog_search/](../../../src/fdai/delivery/catalog_search/) | Deterministic Rule manifests, concept-first `catalog.search_rules`, atomic in-memory/PostgreSQL generations and compatibility-gated retained-generation rollback receipts, OPA-free API reference loading, and safe lexical degradation. |
...
| [scripts/agent/design_context.py](../../../scripts/agent/design_context.py) / [external_operation_guard.py](../../../scripts/agent/external_operation_guard.py) / [.github/hooks/design-context.json](../../../.github/hooks/design-context.json) | Records design-context reads only, hard-blocks stale context for framework and constitutional edits, prevents duplicate repository-wide validation, and defers slow CI, deployment, and image work until `HEAD` has a validation receipt. |
