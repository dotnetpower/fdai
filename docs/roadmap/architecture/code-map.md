...
receipt.
The private Blob module preserves the prior deployer role while adding the stable runner at a
separate Terraform address, so certification planning rejects role replacement and deletion.
