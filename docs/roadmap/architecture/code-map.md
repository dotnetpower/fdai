...
| human_assignment | Immutable human role and agent-duty intent, normalized independent review quorum, revisioned StateStore transitions, Owner-only observation API, Assignments console, and shadow-first allowlisted Entra apply with independent ownership/IAM receipts | [src/fdai/core/human_assignment/](../../../src/fdai/core/human_assignment/), [human_assignments.py](../../../src/fdai/delivery/read_api/routes/human_assignments.py), [identity/](../../../src/fdai/delivery/identity/), and [human_access.py](../../../src/fdai/runtime/human_access.py) | [tests/core/human_assignment/](../../../tests/core/human_assignment/), [test_human_assignments.py](../../../tests/delivery/read_api/test_human_assignments.py), [tests/delivery/identity/](../../../tests/delivery/identity/), and [settings-iam-assignments.test.tsx](../../../console/src/routes/settings-iam-assignments.test.tsx) |
...
| assurance_twin | Read-only ontology twin with persisted active/challenger effect models and bounded runtime no-op/action branch simulation (never executes) | [src/fdai/core/assurance_twin/](../../../src/fdai/core/assurance_twin/) | [tests/assurance_twin/](../../../tests/assurance_twin/) |
