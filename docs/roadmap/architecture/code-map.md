...
| human_assignment | Immutable human role and agent-duty intent, normalized independent review quorum, revisioned StateStore transitions, Owner-only observation API, Assignments console, and independent ownership/IAM effect receipts | [src/fdai/core/human_assignment/](../../../src/fdai/core/human_assignment/), [human_assignments.py](../../../src/fdai/delivery/read_api/routes/human_assignments.py), and [settings-iam-assignments.tsx](../../../console/src/routes/settings-iam-assignments.tsx) | [tests/core/human_assignment/](../../../tests/core/human_assignment/), [test_human_assignments.py](../../../tests/delivery/read_api/test_human_assignments.py), and [settings-iam-assignments.test.tsx](../../../console/src/routes/settings-iam-assignments.test.tsx) |
