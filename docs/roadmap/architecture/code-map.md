...
| human_assignment | Immutable role/duty intent, independent review, revisioned effects, shadow-first Entra apply, and restart-safe handover goals with fatigue budgets and evidence-only review | [src/fdai/core/human_assignment/](../../../src/fdai/core/human_assignment/), [human_assignments.py](../../../src/fdai/delivery/read_api/routes/human_assignments.py), [handover_goals.py](../../../src/fdai/delivery/read_api/routes/handover_goals.py), [identity/](../../../src/fdai/delivery/identity/), and [human_access.py](../../../src/fdai/runtime/human_access.py) | [tests/core/human_assignment/](../../../tests/core/human_assignment/), [test_human_assignments.py](../../../tests/delivery/read_api/test_human_assignments.py), [test_handover_goals.py](../../../tests/delivery/read_api/test_handover_goals.py), [tests/delivery/identity/](../../../tests/delivery/identity/), and [settings-iam-assignments.test.tsx](../../../console/src/routes/settings-iam-assignments.test.tsx) |
