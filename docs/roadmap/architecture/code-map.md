...
> **Scope:** This map describes repository ownership at local IS-08 base `f19cbeb73`. The source and
> test moves are present, but IS-08 remains in progress until the parallel Dockerfile and layout-gate
> lanes merge and pass. IS-07 live upgrade and rollback proof follows from this final local layout.
