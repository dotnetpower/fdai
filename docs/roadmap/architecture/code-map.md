...
| Rule-catalog profile binding | One startup resolution of the governed `FDAI_PROFILE_ID` into the immutable rule tuple the T0 index carries, with fail-closed selection and grading and tenant-free startup diagnostics | [rule_profile.py](../../../services/core-control-plane/src/fdai/runtime/rule_profile.py) | [rule profile tests](../../../services/core-control-plane/tests/runtime/test_rule_profile.py) |
