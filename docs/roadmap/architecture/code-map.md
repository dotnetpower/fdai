...
| tiers/t2_reasoning | Frontier-model reasoning (novel cases only), bounded per event by the declared model budget and escalating to HIL when it is spent | [src/fdai/core/tiers/t2_reasoning/](../../../src/fdai/core/tiers/t2_reasoning/) | [tests/core/tiers/](../../../tests/core/tiers/) | [llm-strategy.md](llm-strategy.md) |
