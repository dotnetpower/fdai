...
|---------|------------------------|-------------|
| Environment model binding | Shared authority-free policy contract, unique capability identities, deterministic resolution with exact GA version, TPM/PTU evidence, and bounded live-provider deadlines, Owner-only drafts, request-kind and policy-bound exact apply, and independent provider readback | [shared contract](../../../packages/service-contracts/src/fdai_service_contracts/model_binding.py), [resolver schema](../../../services/core-control-plane/src/fdai/rule_catalog/schema/model_binding_policy.py), [plan verifier](../../../scripts/deployment/azure/verify-deployment-plan.py), [provider readback](../../../scripts/deployment/azure/verify_model_deployments.py), [Operator IAM adapter](../../../services/operator-service/src/fdai_operator_service/postgres_iam.py), and [Console editor](../../../console/src/routes/settings-model-binding-policy.tsx) |
