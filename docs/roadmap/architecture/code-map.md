...
| Kubernetes rollout evidence | Allowlisted Deployment and Pod rollout observations plus a pure freshness- and conflict-aware reducer that never claims root cause or execution authority | [Kubernetes inventory source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py) and [rollout reducer](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_evidence.py) | [inventory source tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py) and [rollout reducer tests](../../../services/core-control-plane/tests/core/ontology_platform/test_kubernetes_rollout_evidence.py) |
