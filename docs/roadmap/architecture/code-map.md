...
| [src/fdai/rule_catalog/pipeline/distill/](../../../src/fdai/rule_catalog/pipeline/distill/) | Build-time manual compilation plus claim inventory, review-only ontology proposals, authority/identity/evidence gates, lifecycle plans, and frozen-corpus promotion evidence. |
