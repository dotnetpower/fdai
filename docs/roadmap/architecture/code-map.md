...
| runtime_bootstrap | Process composition and long-running task orchestration, with configuration, health-server, required-task, main, and shutdown-signal boundaries isolated as lifecycle helpers | [src/fdai/runtime/bootstrap.py](../../../src/fdai/runtime/bootstrap.py) and [src/fdai/runtime/bootstrap_lifecycle.py](../../../src/fdai/runtime/bootstrap_lifecycle.py) | [tests/runtime/test_bootstrap_config.py](../../../tests/runtime/test_bootstrap_config.py) |
| readiness | Operational handoff, deterministic startup probes, and agent-owned monitored-target readiness with fail-closed reduction, evidence expiry, authority ceilings, and durable transitions ([design](../operations/startup-and-lifecycle.md)) | [src/fdai/core/readiness/](../../../src/fdai/core/readiness/), [src/fdai/runtime/readiness.py](../../../src/fdai/runtime/readiness.py), [src/fdai/delivery/startup_probe.py](../../../src/fdai/delivery/startup_probe.py), and [src/fdai/delivery/analyzer_tick_cli.py](../../../src/fdai/delivery/analyzer_tick_cli.py) | [tests/core/readiness/](../../../tests/core/readiness/), [tests/agents/test_detection_readiness.py](../../../tests/agents/test_detection_readiness.py), [tests/runtime/test_readiness.py](../../../tests/runtime/test_readiness.py), and [tests/delivery/test_analyzer_tick_cli.py](../../../tests/delivery/test_analyzer_tick_cli.py) |
