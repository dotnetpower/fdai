...
| Operational-history lifecycle Job | Shadow scheduling, bounded PostgreSQL partition evidence, private Blob archive verification, restore sampling, hold evaluation, pressure reporting, and receipt-gated purge | [operational_history_lifecycle_runner.py](../../../services/core-control-plane/src/fdai/delivery/operational_history_lifecycle_runner.py), [PostgreSQL repository](../../../services/core-control-plane/src/fdai/delivery/persistence/postgres_operational_history_lifecycle_runner.py), and [Terraform Job](../../../infra/modules/compute/container-apps/operational_history_lifecycle_job.tf) | [runner tests](../../../services/core-control-plane/tests/delivery/test_operational_history_lifecycle_runner.py) and [infrastructure contract](../../../tests/integration/infra/test_operational_history_lifecycle_job.py) |
...
| FDAI Console localization catalogs | Shared shell, Incident, and Alerts labels remain in the base bilingual catalog. Route-specific Teams integration and optional Cost Governance labels stay in lazy route catalogs, so specialized guidance does not consume the entry-bundle budget or activate a package. Changes to the base catalogs regenerate the question-bank digests. | [base English catalog](../../../console/src/i18n/messages.en.json), [base Korean catalog](../../../console/src/i18n/messages.ko.json), and [route catalogs](../../../console/src/routes/i18n/) |
...
| FDAI Console Dashboard v2 checkpoint | Additive resource-first `/dashboard-v2` route, bounded honeycomb, type autocomplete, and inventory projection decoding. The existing Dashboard and Cost Governance routes remain unchanged. Native integration is in progress, not production-validated. | [route](../../../console/src/routes/dashboard-v2.tsx), [decoder](../../../console/src/routes/dashboard-v2.model.ts), and [adoption ledger](../../roadmap-implementation/interfaces/console-operations.md) |
