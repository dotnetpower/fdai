...
- [ ] Wire the accountable pantheon agent to the Rule generation command and result topics, then record a governed runtime receipt that proves durable activation-result publication and idempotent consumption.
