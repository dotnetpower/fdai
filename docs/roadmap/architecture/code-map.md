...
| ontology_platform | Exact releases, semantic interfaces, bounded ObjectSets, mutation planning, typed functions, projection and reconciliation, coverage-reporting provider-observed inventory topology projection, proposal-only SDK generation | [src/fdai/core/ontology_platform/](../../../src/fdai/core/ontology_platform/) | [tests/core/ontology_platform/](../../../tests/core/ontology_platform/) |
