...
| Observation-mode ARB ontology loop | Typed Huginn Change ingress, authenticated context and evidence-source seam, bounded copy-on-write scenario, Forseti-owned DecisionCase and ImpactEnvelope observation verdict, Saga audit, and lineage-derived ReviewCase projection with idempotent replay | [observation loop](../../../services/core-control-plane/src/fdai/core/architecture_review/observation_loop.py), [Forseti binding](../../../services/core-control-plane/src/fdai/agents/forseti.py), and [ARB projection](../../../services/core-control-plane/src/fdai/core/architecture_review/projection.py) | [observation trace tests](../../../services/core-control-plane/tests/core/architecture_review/test_observation_loop.py), [projection tests](../../../services/core-control-plane/tests/core/architecture_review/test_projection.py), and [readiness tests](../../../services/core-control-plane/tests/core/architecture_review/test_readiness.py) |
