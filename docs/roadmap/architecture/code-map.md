...
| Kubernetes workload evidence | Allowlisted Deployment and Pod observations, exact target selection, issued two-hop ownership evidence in both rollout and Pod-owner directions, reviewed immutable-Pod restart-history metrics, and pure freshness- and conflict-aware rollout, same-UID recovery, and distinct-UID replacement reducers that never claim root cause or execution authority. A durable, resumable lifecycle collector now persists cluster/namespace/UID/reason-typed evidence behind an atomic cursor-plus-append-only store; replacement query binding still waits on wiring that evidence into the reducer rather than inferring missing historical observations. | [Kubernetes inventory source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py), [rollout query](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_queries.py), [Pod recovery query](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_pod_recovery_queries.py), [Pod replacement reducer](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_pod_replacement_evidence.py), [semantic planners](../../../services/core-control-plane/src/fdai/core/conversation/), [lifecycle observation model](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_lifecycle_observation.py), [lifecycle source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_lifecycle_source.py), [lifecycle collector](../../../services/core-control-plane/src/fdai/delivery/kubernetes_lifecycle_collector.py), [lifecycle Postgres store](../../../services/core-control-plane/src/fdai/delivery/persistence/postgres_kubernetes_lifecycle.py), [lifecycle Core migration](../../../service-migrations/branches/core-control-plane/versions/20260828_core_kubernetes_lifecycle.py), and [lifecycle collector CLI](../../../services/core-control-plane/src/fdai/delivery/kubernetes_lifecycle_collector_cli.py) | [inventory source tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py), [workload reducer tests](../../../services/core-control-plane/tests/core/ontology_platform/), [planner tests](../../../services/core-control-plane/tests/conversation/), [composition tests](../../../services/core-control-plane/tests/composition/), [lifecycle observation tests](../../../services/core-control-plane/tests/core/ontology_platform/test_kubernetes_lifecycle_observation.py), [lifecycle source tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_lifecycle_source.py), [lifecycle collector tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_lifecycle_collector.py), [lifecycle Postgres store tests](../../../services/core-control-plane/tests/persistence/test_postgres_kubernetes_lifecycle.py), and [lifecycle CLI tests](../../../services/core-control-plane/tests/delivery/test_kubernetes_lifecycle_collector_cli.py) |
