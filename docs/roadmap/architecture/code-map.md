...
| isolated_executor | SD-07 durable shadow command validation, duplicate/reorder/restart convergence, and terminal no-effect receipts. Ingress, workload identity, Container App deployment, and effect authority remain unbound. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py) and [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
