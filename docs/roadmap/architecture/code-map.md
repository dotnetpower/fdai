...
| operational_learning | Strict outcome classification and bounded Muninn cohorts compiled into inert Norns candidates behind Mimir guard | [src/fdai/core/operational_learning/](../../../src/fdai/core/operational_learning/) | [tests/core/operational_learning/](../../../tests/core/operational_learning/), [test_norns_operating_pattern.py](../../../tests/agents/test_norns_operating_pattern.py), and [test_operating_pattern_learning_e2e.py](../../../tests/agents/test_operating_pattern_learning_e2e.py) |
...
| runtime_bootstrap | Process composition and long-running task orchestration, including durable T2 recovery receipts forwarded through Huginn, with configuration, health-server, required-task, task-supervision, main, and shutdown-signal boundaries isolated as lifecycle helpers | [src/fdai/runtime/bootstrap.py](../../../src/fdai/runtime/bootstrap.py), [src/fdai/runtime/t2_recovery.py](../../../src/fdai/runtime/t2_recovery.py), and [src/fdai/runtime/bootstrap_lifecycle.py](../../../src/fdai/runtime/bootstrap_lifecycle.py) | [tests/runtime/test_bootstrap_config.py](../../../tests/runtime/test_bootstrap_config.py) and [tests/runtime/test_t2_recovery.py](../../../tests/runtime/test_t2_recovery.py) |
