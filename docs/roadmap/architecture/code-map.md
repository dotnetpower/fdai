...
| FDAI Console localization catalogs | Shared shell, Incident, Alerts, and channel-setup labels remain in the base bilingual catalog. Optional Cost Governance labels stay in the package-specific route catalog, so a shared label change cannot activate or configure the package. | [base English catalog](../../../console/src/i18n/messages.en.json), [base Korean catalog](../../../console/src/i18n/messages.ko.json), and [Cost Governance route catalogs](../../../console/src/routes/i18n/) |
