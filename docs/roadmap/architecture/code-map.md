...
| Document Processing Worker | Durable document processing, process-isolated Korean and English OCR, and worker-owned local or Azure provider adapters | [package](../../../services/document-processing-worker/src/fdai_document_worker_service/), [local OCR](../../../services/document-processing-worker/src/fdai_document_worker_service/adapters/local_ocr.py), and [provider policy contract](../../../packages/service-contracts/src/fdai_service_contracts/document_ocr.py) |
