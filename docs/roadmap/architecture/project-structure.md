...
│   │   ├── conversation/       # operator-console intent/tool coordination, conflict-aware read plans, clarification, dynamic grounded narration with atomic-claim fallback, safe attachments, per-turn isolation, durable delivery, adapter health, and busy-input arbitration
