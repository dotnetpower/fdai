...
│   │   ├── kubernetes/         # shared operational Kubernetes semantics, including exact resource-quantity normalization and bounded Node capacity projection used by evaluation and runtime evidence
