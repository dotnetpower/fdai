...
`execution_unknown`, and terminal or publication replay never repeats the rollback. HIL resume resolves catalog rules from the current catalog and accepts a parked server-validated operator-request rule
