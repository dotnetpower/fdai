...
comparison, T1 rejects malformed reuse identities, counters, confidence, and similarity evidence instead of raising, and T2 rejects any proposed target, resource type, citation, or ActionType that differs
