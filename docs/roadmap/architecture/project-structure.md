...
Cloud update comparison validates raw and processing identities; shared contracts bound context and derived text, and Core rechecks all immutable source metadata before rendering.
