...
The local five-service profile keeps each package independent over loopback PostgreSQL, Redpanda, filesystem document storage, and ClamAV. Deployed composition replaces those adapters
