...
│   │   ├── kubernetes/         # shared operational Kubernetes semantics: exact quantities, bounded projections, and hold-only capacity, dependency, and admission-drift findings
