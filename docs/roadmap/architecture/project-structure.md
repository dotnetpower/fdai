...
New cloud-reference packages use normalized-only v2 records; collector originals stay API-owned, while package/worker readers preserve exact v1 identity and unchanged approval gates.
