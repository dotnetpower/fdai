...
Cloud update comparison validates raw and processing identities; Core rechecks immutable provenance and treats each cloud version as a collection under the existing total excerpt budget.
