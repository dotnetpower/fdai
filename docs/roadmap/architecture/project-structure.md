...
| Rule / policy source | rule-catalog + `policies/` loader, `RuleIndex`, and `CatalogIndexLifecycle` | - | bundled generic rules with atomic current/N-1 dispatch indexes | customer rule set / thresholds |
