...
[Alert noise governance](../operations/alert-noise-governance.md) owns typed evidence, Process and conditional manual PRs. Its dedicated Operator composition binds projections, preferences, history and one supervised bridge; the shared root owns lifecycle only. Shared admission inventory pins record and Workflow-promotion decision guards. Catalog tests follow current contracts, not rejected R7; generated/offline evidence grants no authority or operational certification.
