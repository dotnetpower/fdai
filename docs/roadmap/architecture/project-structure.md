...
│   │   ├── operational_context/ # atomic owned-subgraph replacement and time-consistent snapshots with typed evidence paths, object revisions, source-freshness receipts, and fail-closed truncation
