...
│   │   ├── conversation/       # Bragi-owned screen scope, operator-console contextual intent/tool coordination, pure tool-argument parsing, conflict-aware read plans, clarification, grounded narration, per-turn isolation, durable delivery, and busy-input arbitration
