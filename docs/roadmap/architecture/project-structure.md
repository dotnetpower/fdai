...
│   │   ├── quality_gate/       # mixed-model cross-check, verifier, grounding, deterministic rubric shadow-to-enforce decision; failed fan-out cancels and drains siblings (guards T2)
