...
share one durable delivery-completion boundary. Broker replay therefore cannot inflate, erase, or strand evidence. HIL resume resolves catalog rules from the current catalog and accepts a parked server-validated operator-request rule
