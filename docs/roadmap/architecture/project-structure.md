...
│   │   ├── kubernetes/         # shared operational Kubernetes semantics: exact quantities, bounded Pod request and Node capacity projection, and hold-only request-versus-ceiling findings
