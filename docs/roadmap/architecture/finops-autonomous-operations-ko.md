...
translation_source_sha: 8a81b2fdd5aa5955a03300c296a149217329db30
...
> 하드닝 라운드 1-7은 campaign 혼합, option 대체, 자산 중복 소유, cursor 없는 읽기를 차단하고 인증, 메모리, 공개 경계를 보존합니다. 런타임 권한은 바뀌지 않습니다.
