...
translation_source_sha: 75e62bfcfb5eba1b4e0f0462f7d6abb0362d87fc
...
| isolated_executor | SD-07 durable shadow command 검증, poison record를 dead-letter하는 EventBus ingress, duplicate/reorder/restart 수렴, effect 없는 terminal receipt publish 및 supervised health를 담당합니다. Production adapter composition, workload identity, Container App 배포 및 effect authority는 아직 bind하지 않습니다. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py) 및 [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py) 및 [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
