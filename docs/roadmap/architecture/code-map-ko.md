...
translation_source_sha: d576cda2358dce5cc83526ad0c54e7e50763a8db
...
필요한 모든 LinkType 증적을 결속합니다. 현재 서비스와 Agent 간 소유권은 인벤토리 인스턴스와
온톨로지 선언을 결합하는 명시적 복합 권한 계약이 마련될 때까지 사용할 수 없는 상태로 유지합니다.
