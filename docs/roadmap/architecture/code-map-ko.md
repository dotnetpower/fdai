...
translation_source_sha: 515b0d88b33092e3d4f7f529599f94c7983027ff
...
프롬프트 ablation은 선택적 맥락만 제거하고 모든 제외 항목을 재실행을 위해 기록합니다. 서비스 계약 호환성 매니페스트는 적응형 `1.6.0` 전송에 버전 협상을 적용합니다. 구형 변환은 일반 묶음에만 적용되며 의미 처리 근거를 버릴 수 없습니다.
