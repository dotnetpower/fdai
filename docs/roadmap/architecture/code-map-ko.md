...
translation_source_sha: f24acadd7c448c4b1dbf7a18c5186399cff1de56
...
| Kubernetes rollout 근거 | 허용 목록에 있는 Deployment 및 Pod 관측, 정확한 대상 선택, 발급된 2단계 소유권 근거, 근본 원인 또는 실행 권한을 주장하지 않는 최신성 및 충돌 인식 순수 축약기 | [Kubernetes 인벤토리 source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py), [rollout 조회](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_queries.py), [의미 플래너](../../../services/core-control-plane/src/fdai/core/conversation/semantic_kubernetes_rollout_planning.py) | [인벤토리 source 테스트](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py), [rollout 축약기 테스트](../../../services/core-control-plane/tests/core/ontology_platform/test_kubernetes_rollout_evidence.py), [플래너 테스트](../../../services/core-control-plane/tests/conversation/test_semantic_kubernetes_rollout_planning.py), [조립 테스트](../../../services/core-control-plane/tests/composition/test_wire_kubernetes_rollout.py) |
