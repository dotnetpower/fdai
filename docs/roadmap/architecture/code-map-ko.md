...
translation_source_sha: 361cb590810576380c905b0828dd68f64cce40da
...
| workflow | Version-pinned WorkflowDefinition을 컴파일 및 실행합니다. 승인 quorum은 정규화된 principal을 셉니다. Enforce action step은 independently verified outcome receipt를 기다리고, partial failure는 reverse typed compensation 전에 intent를 기록하며 verified recovery 후에만 종료합니다. Recovery-incomplete 종료는 durable target hold를 먼저 기록하고 RiskGate는 hold가 active이거나 unreadable이면 ordinary action을 deny합니다. Approved recovery bypass와 hold release는 계획 상태입니다. | [src/fdai/core/workflow/](../../../src/fdai/core/workflow/) | [tests/core/workflow/](../../../tests/core/workflow/) |
