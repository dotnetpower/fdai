...
translation_source_sha: 1e1e58aa34ae4c88710a62f706d3f915dcb30543
...
| 지속형 운영 인스턴스 그래프 | 연속 수집, snapshot과 overlay 승격, ontology 및 topology-history projection, graph-first query, 범위가 제한된 retention과 archive gap의 source-to-store 소유권 | [소유 설계](continuous-operational-instance-graph-ko.md), [감사 계약](../../../config/continuous-operational-instance-graph-audit.json), [inventory delivery](../../../services/core-control-plane/src/fdai/delivery/), [ontology platform](../../../services/core-control-plane/src/fdai/core/ontology_platform/) | [감사 테스트](../../../tests/integration/scripts/test_continuous_operational_instance_graph_audit.py) |
