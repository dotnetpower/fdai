...
translation_source_sha: e7cb6c760eff075983b555b626b58fa2ade371fb
...
| isolated_executor | SD-07 durable shadow command 검증, 주입된 logical-target lock, earliest-offset EventBus ingress와 poison record dead-letter, effect 없는 terminal receipt publish, supervised health, fail-closed production composition 및 effect 권한이 없는 전용 identity를 사용하는 opt-in internal Container App을 담당합니다. Terraform은 app을 기본 비활성화하며 live apply, exact-topology smoke 및 rollback evidence는 남아 있습니다. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py), [src/fdai/runtime/isolated_executor_lock.py](../../../src/fdai/runtime/isolated_executor_lock.py), [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py), [src/fdai/runtime/isolated_executor_cli.py](../../../src/fdai/runtime/isolated_executor_cli.py) 및 [infra/modules/isolated-executor/container-app/](../../../infra/modules/isolated-executor/container-app/) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_lock.py](../../../tests/runtime/test_isolated_executor_lock.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py), [tests/runtime/test_isolated_executor_cli.py](../../../tests/runtime/test_isolated_executor_cli.py), [tests/infra/test_isolated_executor_boundary.py](../../../tests/infra/test_isolated_executor_boundary.py) 및 [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
