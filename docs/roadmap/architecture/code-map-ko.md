...
translation_source_sha: 9264538727fe47924c2a011a74ecc80aa9fc7b56
...
| change_lineage | Canonical `ChangeRecord`와 `ChangeAssessment`부터 선택한 `DecisionCase` option, `Action`, `ResponseOutcome`까지 변경 불가능하고 replay-stable하게 연결합니다. Record 간 identity, target, digest, causal order 불일치를 차단하며 execution 또는 promotion authority를 부여하지 않습니다. | [src/fdai/core/change_lineage/](../../../src/fdai/core/change_lineage/) | [tests/core/change_lineage/](../../../tests/core/change_lineage/) |
