...
translation_source_sha: 761843ee885a27944798f6ea55da3062d2a6c741
...
| ARB 관찰 추적 | 명시적인 소유자, ID, 기한, 충돌 및 권한 없음 검사로 고정된 Huginn, Muninn, 전문 에이전트, Forseti, Saga 경계를 재생 가능한 상태로 변환합니다. | [아키텍처 검토](../../../services/core-control-plane/src/fdai/core/architecture_review/) | [아키텍처 검토 테스트](../../../services/core-control-plane/tests/core/architecture_review/) |
