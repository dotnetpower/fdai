...
translation_source_sha: 2e61b5ee543bd323adeaeadfef8da1becb2830b0
...
| isolated_executor | SD-07 durable shadow command 검증, 주입된 logical-target lock, poison record를 dead-letter하는 EventBus ingress, duplicate/reorder/restart 수렴, effect 없는 terminal receipt publish 및 supervised health를 담당합니다. Production adapter composition, workload identity, Container App 배포 및 effect authority는 아직 bind하지 않습니다. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py), [src/fdai/runtime/isolated_executor_lock.py](../../../src/fdai/runtime/isolated_executor_lock.py) 및 [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_lock.py](../../../tests/runtime/test_isolated_executor_lock.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py) 및 [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
