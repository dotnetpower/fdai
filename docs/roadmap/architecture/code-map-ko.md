...
translation_source_sha: e436917dd000ed359799e66aebb1f30da52a9be4
...
| 규칙 거버넌스 재정의 및 예외 | 스키마로 검증하는 범위 지정 재정의 해석, 제한된 매개 변수 완화, 분리된 요청자와 승인자 신원, 만료 계획, 알림 재시도 근거, 실행 권한을 부여하지 않는 컨트롤 루프 감사 전달 | [거버넌스 스키마](../../../services/core-control-plane/src/fdai/rule_catalog/schema/), [수명 주기 조정기](../../../services/core-control-plane/src/fdai/delivery/exemption_lifecycle.py), [컨트롤 루프](../../../services/core-control-plane/src/fdai/core/control_loop/), [의미 조회 변환 결과](../../../services/core-control-plane/src/fdai/core/ontology_platform/resource_state_queries.py) | [스키마 테스트](../../../services/core-control-plane/tests/rule_catalog/schema/), [수명 주기 테스트](../../../services/core-control-plane/tests/delivery/test_exemption_lifecycle.py), [컨트롤 루프 테스트](../../../services/core-control-plane/tests/core/test_control_loop_governance_override.py), [의미 조회 테스트](../../../services/core-control-plane/tests/core/ontology_platform/test_resource_state_queries.py) |
