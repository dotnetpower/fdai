...
translation_source_sha: c379841671563602dcb9c240c7828dd5cdf7a416
...
| hil_resume | 사람 결정까지 park/resume합니다. Principal identity는 대소문자를 구분하지 않고 비교하므로, object id의 표기를 바꿔 한 사람을 두 사람처럼 보이게 해서 no-self-approval 바닥을 무너뜨릴 수 없습니다. no-drop load plan, group당 initial dispatch 1개, atomic expiry reaping, bounded reminder, durable decision delivery 및 CAS 소유 shadow non-response ladder를 제공합니다. | [src/fdai/core/hil_resume/](../../../src/fdai/core/hil_resume/), [hil_registry.py](../../../src/fdai/shared/providers/hil_registry.py), [hil_decision.py](../../../src/fdai/delivery/chatops/hil_decision.py) | [tests/core/hil_resume/](../../../tests/core/hil_resume/), [test_hil_callback.py](../../../tests/delivery/read_api/test_hil_callback.py), [test_hil_decision.py](../../../tests/delivery/test_hil_decision.py) | [channels-and-notifications-ko.md](../interfaces/channels-and-notifications-ko.md) |
...
| human_assignment | 변경 불가능한 사용자 역할 및 agent duty 의도, 정규화된 독립 검토 정족수, 리비전 기반 StateStore 전환, Owner 전용 관찰 API, Assignments 콘솔, 관찰 모드 우선 허용 목록 Entra 적용, 독립적인 담당 체계/IAM 결과 영수증 | [src/fdai/core/human_assignment/](../../../src/fdai/core/human_assignment/), [human_assignments.py](../../../src/fdai/delivery/read_api/routes/human_assignments.py), [identity/](../../../src/fdai/delivery/identity/), [human_access.py](../../../src/fdai/runtime/human_access.py) | [tests/core/human_assignment/](../../../tests/core/human_assignment/), [test_human_assignments.py](../../../tests/delivery/read_api/test_human_assignments.py), [tests/delivery/identity/](../../../tests/delivery/identity/), [settings-iam-assignments.test.tsx](../../../console/src/routes/settings-iam-assignments.test.tsx) |
