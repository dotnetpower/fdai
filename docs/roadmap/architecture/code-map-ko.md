...
translation_source_sha: 63e859542f90c42a66f76e86d2fcd6701f01125f
...
| assurance_twin | Scalar 및 graph active/challenger effect model, immutable state trajectory, bounded typed-path propagation, Dynamic invariant, independent outcome closure, shadow runtime audit을 포함한 read-only ontology twin (실행 금지) | [src/fdai/core/assurance_twin/](../../../src/fdai/core/assurance_twin/) | [tests/assurance_twin/](../../../tests/assurance_twin/) |
