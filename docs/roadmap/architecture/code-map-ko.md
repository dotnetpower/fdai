...
translation_source_sha: 7a3580b3d4b575b133d08e7067761022e6fbcd53
...
| isolated_executor | SD-07 durable shadow command 검증, duplicate/reorder/restart 수렴 및 effect 없는 terminal receipt를 담당합니다. Ingress, workload identity, Container App 배포 및 effect authority는 아직 bind하지 않습니다. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py) 및 [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
