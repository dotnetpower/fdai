...
translation_source_sha: 1d7ca7f5fe0c5e6dd203f574c250defb7ad3140a
...
BusinessService에서 Agent로 이어지는 실제 인스턴스 경로를 보존합니다.
