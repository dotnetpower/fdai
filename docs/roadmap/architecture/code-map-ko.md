...
translation_source_sha: 47ec9d1847bd8bb68fe13140b26562a0097d1a35
...
비공개 Blob 모듈은 이전 배포자 역할을 보존하면서 안정적인 runner를 별도 Terraform 주소에
추가하므로, 인증 계획은 역할 교체와 삭제를 차단합니다.
