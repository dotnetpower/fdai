...
translation_source_sha: c7db31a270866295f52edd2f7cb920a807fd8e2b
...
| workflow | Version-pinned WorkflowDefinition을 컴파일 및 실행합니다. 승인 quorum은 정규화된 principal을 셉니다. Enforce action step은 independently verified outcome receipt를 기다리고, partial failure는 reverse typed compensation 전에 intent를 기록하며 verified recovery 후에만 종료합니다. Recovery가 없거나 unscorable이면 success가 아닌 명시적 failure입니다. | [src/fdai/core/workflow/](../../../src/fdai/core/workflow/) | [tests/core/workflow/](../../../tests/core/workflow/) |
