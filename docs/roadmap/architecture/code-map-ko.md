...
translation_source_sha: dc00d8ca04cf1cc17b42f743f6d12c4fb016792c
...
| isolated_executor | SD-07 durable shadow command 검증, 주입된 logical-target lock, earliest-offset EventBus ingress와 poison record dead-letter, effect 없는 terminal receipt publish, supervised health 및 fail-closed production composition을 담당합니다. Entrypoint는 전용 shadow identity와 durable state를 요구하지만 effect adapter를 import하지 않습니다. Container App 배포 및 effect authority는 아직 bind하지 않습니다. | [src/fdai/runtime/isolated_executor.py](../../../src/fdai/runtime/isolated_executor.py), [src/fdai/runtime/isolated_executor_lock.py](../../../src/fdai/runtime/isolated_executor_lock.py), [src/fdai/runtime/isolated_executor_runtime.py](../../../src/fdai/runtime/isolated_executor_runtime.py) 및 [src/fdai/runtime/isolated_executor_cli.py](../../../src/fdai/runtime/isolated_executor_cli.py) | [tests/runtime/test_isolated_executor_shadow.py](../../../tests/runtime/test_isolated_executor_shadow.py), [tests/runtime/test_isolated_executor_lock.py](../../../tests/runtime/test_isolated_executor_lock.py), [tests/runtime/test_isolated_executor_runtime.py](../../../tests/runtime/test_isolated_executor_runtime.py), [tests/runtime/test_isolated_executor_cli.py](../../../tests/runtime/test_isolated_executor_cli.py) 및 [tests/contracts/test_executor_transport.py](../../../tests/contracts/test_executor_transport.py) |
