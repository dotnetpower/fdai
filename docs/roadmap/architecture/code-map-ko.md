...
translation_source_sha: 6f7eab46caaa1c91fefca93be59a940715f99858
...
| Kubernetes rollout 근거 | 허용 목록에 있는 Deployment 및 Pod rollout 관측과, 근본 원인 또는 실행 권한을 주장하지 않는 최신성 및 충돌 인식 순수 축약기 | [Kubernetes 인벤토리 source](../../../services/core-control-plane/src/fdai/delivery/kubernetes_api_inventory.py), [rollout 축약기](../../../services/core-control-plane/src/fdai/core/ontology_platform/kubernetes_rollout_evidence.py) | [인벤토리 source 테스트](../../../services/core-control-plane/tests/delivery/test_kubernetes_api_inventory.py), [rollout 축약기 테스트](../../../services/core-control-plane/tests/core/ontology_platform/test_kubernetes_rollout_evidence.py) |
