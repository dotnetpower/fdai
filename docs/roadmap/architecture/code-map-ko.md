...
translation_source_sha: 5baa6c2d55a523c2cfaee28d34d8da05f60f29d4
...
| ARB 관찰 추적 | 명시적인 소유자, ID, 기한, 중복, 재시작, 충돌, 권한 없음 검사와 종료된 observer 성능 저하 근거 보존을 포함해 고정된 Huginn, Muninn, 전문 에이전트, Forseti, Saga 경계를 런타임에 연결된 재생 가능한 관찰 경로로 변환합니다. | [아키텍처 검토](../../../services/core-control-plane/src/fdai/core/architecture_review/) | [아키텍처 검토 테스트](../../../services/core-control-plane/tests/core/architecture_review/) |
