...
translation_source_sha: 86a52371811de51b9aa614e32f73e23ca92a89f1
...
- **주기적 조정은 계속 필요합니다.** 가져올 수 있는 인벤토리 sync CLI는 기본 6시간 주기로
  ...
  검사합니다. 시도 하나는 실제 시간 마감으로 제한되므로, 멈춘 프로바이더는 이후 모든 검사를
  막는 대신 자기 시도를 실패시킵니다. ARG 요청은 모든 샤드가 공유하는 지속 예산에 맞춰
