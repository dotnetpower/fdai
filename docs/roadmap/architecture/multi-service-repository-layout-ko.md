...
translation_source_sha: 4453edff580dd6e80e8ca67eabe099fe12ce699d
...
| Core 서비스 진입점 | Core manifest는 shadow 운영 이력 lifecycle Job과 Container Apps에서 사용하는 positional 보호 certification runner를 포함해 서비스 소유의 범위가 제한된 유지 관리 진입점을 노출합니다. 각 진입점은 Core 패키지 경계 안에서 delivery adapter를 조립하며 executor 권한을 부여하지 않습니다. |
