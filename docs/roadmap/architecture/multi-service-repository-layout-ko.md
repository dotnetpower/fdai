...
translation_source_sha: 66423e285890e96b47161da386e82034076ca78a
...
| Core 서비스 진입점 | Core manifest는 shadow 운영 이력 lifecycle Job을 포함해 서비스 소유의 범위가 제한된 유지 관리 진입점을 노출합니다. 각 진입점은 Core 패키지 경계 안에서 delivery adapter를 조립하며 executor 권한을 부여하지 않습니다. |
