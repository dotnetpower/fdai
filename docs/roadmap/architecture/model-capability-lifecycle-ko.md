...
translation_source_sha: 8c40e059eeb63b5a1c3ca9898fb3d043361a278c
...
감시합니다. 멱등 초안 PR만 열고 실제 매핑은 바꾸지 않습니다. 제안 스키마 v3는 모델 계열,
발행자, 상태뿐 아니라 SKU와 유효 용량 단위 및 값도 비교하므로 제자리 확장이나 교체를 변경
없음으로 잘못 분류하지 않습니다.
