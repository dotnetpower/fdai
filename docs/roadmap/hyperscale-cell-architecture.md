...
> [deploy-and-onboard.md](deploy-and-onboard.md) (Event Hubs Standard 1 TU, one
...
- **Correlation shrinks the audit plane.** `EventCorrelator`
  ([observability-and-detection.md § 1](observability-and-detection.md#1-event-correlation))
...
`standard` profile. This extends [cost-model.md](cost-model.md), which prices
...
> separately in [cost-model.md § T2 LLM Cost](cost-model.md#t2-llm-cost).
...
| Minimum-set remainder (Key Vault, ACR, Bot, ...) | - | **$30 - $40** | carried from [cost-model.md](cost-model.md) |
...
| To learn about | Read |
|----------------|------|
| The two log planes and the audit-write bottleneck | [observability-and-detection.md](observability-and-detection.md) |
| The eight wire-level contracts this preserves | [csp-neutrality.md](csp-neutrality.md) |
| The minimum-cost topology this scales out from | [deploy-and-onboard.md](deploy-and-onboard.md) |
