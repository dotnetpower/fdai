...
result. These checks also do not establish reproducible signed-bundle construction through a
double-build comparison. The current automatic-version workflow publishes version metadata and a
tag only; forks must not treat it as a protected release-batch, signed-bundle publication, or
installation gate.
...
The protected Cost Governance lifecycle, observation, and independent-review workflows are also
...
the review receipt definition, or bypass independent review.
