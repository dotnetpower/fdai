...
- [ ] Implement and separately authorize a `ShadowReversionWriter` adapter; until one exists, a failed
  effect verification still has no executable path back to shadow mode.
