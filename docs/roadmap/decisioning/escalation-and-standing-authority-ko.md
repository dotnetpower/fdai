...
translation_source_sha: 949059adc40191b93fae8ad3b32bd171c661aac7
...
- [ ] `ShadowReversionWriter` 어댑터를 구현하고 별도로 승인합니다. 어댑터가 없는 동안에는 실패한 효과
  검증이 shadow 모드로 돌아갈 실행 가능한 경로를 갖지 못합니다.
