...
translation_source_sha: f44d305fd7f6e0fede55aa4009bc9bd419b97746
...
- [x] 별도로 권한이 적용된 `POST /automation-blueprints/{accept,reject,materialize}` 경로가
  등록되어 approver 이상 권한과 idempotency 키를 요구하며 제안만 남깁니다. API 통합 테스트가
