...
| Live blast probe execution | in-progress | [`live_probe.py`](../../../services/core-control-plane/src/fdai/core/risk_gate/live_probe.py), [`delivery/live_blast_probe.py`](../../../services/core-control-plane/src/fdai/delivery/live_blast_probe.py), [`authority.py`](../../../services/core-control-plane/src/fdai/core/risk_gate/authority.py), and focused probe tests | The production-capable adapter and durable failure-streak contract fail closed over deployment-supplied neutral sources. A deployment binding and governed live receipt remain external gates. |
| Governance and tool execution coverage | implemented | [`promotion.py`](../../../services/core-control-plane/src/fdai/delivery/promotion.py), [`gitops_pr/governance.py`](../../../services/core-control-plane/src/fdai/delivery/gitops_pr/governance.py), [`retirement.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/retirement.py), [`graph_model_promotion.py`](../../../services/core-control-plane/src/fdai/delivery/graph_model_promotion.py), and [`override_writer.py`](../../../services/core-control-plane/src/fdai/core/risk_gate/override_writer.py) | Promotion requires an authenticated exact distinct-approver attestation and rejects bare decisions; retire and exemption writers publish only canonical shadow review PRs with replayable terminal lifecycle evidence, and merged retirements are projected out of the active rule index. |
...
- [ ] Bind `LiveBlastProbeAdapter` to deployment-supplied signal and failure-streak providers, then retain a governed runtime receipt whose resolved ceiling carries a real probe reading.
