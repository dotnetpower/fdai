...
translation_source_sha: 2388173a84fb410870de443307f81ff3acb79cc3
...
> rule-set 로더 (`rule_set.schema.json` + `load_rule_set_from_mapping`)도 같은 모듈에 ship 됨. 남은
> 후속은 resolved assignment 를 소비하는 T0 런타임과 CI 전이 게이트.
