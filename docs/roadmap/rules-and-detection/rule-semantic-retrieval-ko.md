...
translation_source_sha: 26a9d8468d45d666af0f3a86e15a6d51b855d879
...
| 운영 세대 빌드 worker | in-progress | `delivery/catalog_search/rule_generation.py`; `delivery/catalog_search/rule_generation_worker.py`; `rule_catalog/schema/rule_semantic_generation_events.py`; 집중 worker 및 수명 주기 검사 | 영속 빌더와 독립 검증기 primitive는 정확한 세대를 준비하고 재시작 및 동시 처리에서 안정적인 범위 제한 결과 하나를 replay하며 프로바이더 또는 스냅샷 오류 시 안전하게 닫힙니다. Pantheon subscriber와 운영 trigger는 남아 있습니다. |
