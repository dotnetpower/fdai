...
- [ ] Load evaluation thresholds from governed configuration and consume passing receipts through a
  governed promotion gate. Exit when the gate rejects stale, failing, or authority-bearing receipts
