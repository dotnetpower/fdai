...
| Full-corpus generation identity | in-progress | [`rule_semantic_generation.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/rule_semantic_generation.py), [`discovery_rule.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/discovery_rule.py), [`test_rule_semantic_retrieval.py`](../../../services/core-control-plane/tests/rule_catalog/test_rule_semantic_retrieval.py), [`test_discovery_catalog_search.py`](../../../services/core-control-plane/tests/rule_catalog/test_discovery_catalog_search.py) | The schema represents 8,549 rows with count, hierarchical digest root, and bounded chunks. The actual 62 active and 8,487 discovery Rule projections have isolated in-memory lifecycles; delivery metadata and durable-adapter evidence remain open. |
...
- [ ] P2 exits when delivery generation metadata publishes count/root/chunk identities and the
  durable PostgreSQL adapter repeats the already passing 62-active/8,487-discovery activation,
