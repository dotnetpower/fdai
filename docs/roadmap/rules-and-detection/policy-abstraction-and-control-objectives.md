...
| Full-corpus generation identity | in-progress | [`rule_semantic_generation.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/rule_semantic_generation.py), [`test_rule_semantic_retrieval.py`](../../../services/core-control-plane/tests/rule_catalog/test_rule_semantic_retrieval.py), [`test_ontology_generation.py`](../../../services/core-control-plane/tests/delivery/catalog_search/test_ontology_generation.py) | The schema represents 8,549 rows with count, hierarchical digest root, and 34 bounded chunks. In-memory corpus pointers are independent; delivery metadata and durable-adapter evidence remain open. |
