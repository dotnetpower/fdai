...
determine the result. This objective and binding are P1 backfill targets, not existing catalog
records.
...
| `RuleObjectiveBinding` and equivalence receipts | in-progress | [`rule_objective_binding.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/rule_objective_binding.py), [`equivalence_validation.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/equivalence_validation.py), [`test_rule_objective_binding.py`](../../../services/core-control-plane/tests/rule_catalog/test_rule_objective_binding.py), [`test_equivalence_validation.py`](../../../services/core-control-plane/tests/rule_catalog/test_equivalence_validation.py) | Strict bindings and equivalence receipts now pin exact catalog versions and digests with lifecycle and authority-boundary tests; validator execution and shipped catalog records remain open. |
...
- [ ] P0 exits when strict schemas, loaders, content digests, lifecycle validation, and negative
  tests exist for `ControlObjective`, `RuleObjectiveBinding`, and equivalence receipts.
