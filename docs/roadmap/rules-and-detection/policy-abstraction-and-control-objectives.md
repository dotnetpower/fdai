...
| `RuleObjectiveBinding` and equivalence receipts | in-progress | [`equivalence_validation.py`](../../../services/core-control-plane/src/fdai/rule_catalog/schema/equivalence_validation.py), [`test_equivalence_validation.py`](../../../services/core-control-plane/tests/rule_catalog/test_equivalence_validation.py) | Strict version-pinned equivalence receipts, independent claims, loaders, digests, lifecycle checks, and negative tests exist; binding and validator execution remain open. |
