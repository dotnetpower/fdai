...
const TYPE_LAYER: Readonly<Record<string, ArchitectureLayer>> = {
  ...
  kafka: "messaging",
  "compute.image": "runtime",
  "compute.vm": "runtime",
  "compute.vm-extension": "runtime",
  "compute.vm-run-command": "runtime",
  ...
  "network.private-access-scope": "network",
  "network.registered-domain": "network",
  "disk-snapshot": "data",
  "sql-server": "data",
  ...
  "anomaly-alert-rule": "observability",
  "metric-alert-rule": "observability",
  "managed-sre-agent": "observability",
  "observability.dashboard-service": "observability",
  "observability.network-monitor": "observability",
  "observability.query-pack": "observability",
  "observability.solution": "observability",
  "observability.dashboard": "observability",
  "observability.workbook": "observability",
...
const TYPE_COLOR_TOKEN: Readonly<Record<string, ArchitectureResourceColorToken>> = {
  ...
  kafka: "service-bus",
  "compute.image": "virtual-machine",
  "compute.vm": "virtual-machine",
  "compute.vm-extension": "virtual-machine",
  "compute.vm-run-command": "virtual-machine",
  ...
  "workflow.api-connection": "service-bus",
  "workflow.logic-app": "app-service",
  "bot-service": "app-service",
  "ai-project": "app-service",
  "web-search-service": "search",
  ...
  "network.bastion-host": "application-gateway",
  "network.private-access-scope": "private-endpoint",
  "network.registered-domain": "dns-zone",
  "disk-snapshot": "disk",
  "sql-server": "database",
  ...
  "managed-certificate": "certificate",
  ...
  "prometheus-rule-group": "azure-monitor",
  "anomaly-alert-rule": "azure-monitor",
  "metric-alert-rule": "azure-monitor",
  "managed-sre-agent": "azure-monitor",
  "observability.dashboard-service": "azure-monitor",
  "observability.network-monitor": "azure-monitor",
  "observability.query-pack": "log-analytics",
  "observability.solution": "log-analytics",
  "observability.dashboard": "azure-monitor",
  "observability.workbook": "azure-monitor",
...
> = {
  ...
  search: { label: "Search", color: "#0078D4" },
};
