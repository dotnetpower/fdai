...
const en = {
  ...
  unavailable: "Unavailable", notApplicable: "Not applicable", applicabilityUnknown: "Applicability unknown",
...
const ko: Record<keyof typeof en, string> = {
  ...
  unavailable: "사용 불가", notApplicable: "적용 대상 아님", applicabilityUnknown: "적용 여부 알 수 없음",
