...
const en = {
  ...
  stateSourceNotRecorded: "The expected state source did not record a value.",
  ...
  stateStale: "The retained state evidence is older than its freshness ceiling.",
  stateConflicting: "The retained state evidence contains a recorded conflict.",
  stateMetadataIncomplete: "The retained state evidence metadata is incomplete.",
  stateSynthetic: "The retained state is synthetic and is not an observed fact.",
...
const ko: Record<keyof typeof en, string> = {
  ...
  stateSourceNotRecorded: "예상한 상태 출처에 값이 기록되지 않았습니다.",
  ...
  stateStale: "유지된 상태 근거가 최신성 상한보다 오래됐습니다.",
  stateConflicting: "유지된 상태 근거에 기록된 충돌이 있습니다.",
  stateMetadataIncomplete: "유지된 상태 근거 메타데이터가 불완전합니다.",
  stateSynthetic: "유지된 상태가 합성 값이며 관측된 사실이 아닙니다.",
...
export function recordedStateReasonText(reason: string): string | null {
  const key = {
    ...
    state_conflicting: "stateConflicting",
    state_metadata_incomplete: "stateMetadataIncomplete",
    state_synthetic: "stateSynthetic",
