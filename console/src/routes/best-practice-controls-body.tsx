  ...
  const columns: readonly Column<BestPracticeControl>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        cellClass: "control-column-secondary",
        headerClass: "control-column-secondary",
        render: (control) => displayValue("controlMapping", control.mapping_status),
      },
      {
        key: "evaluation",
        ...
        cellClass: "control-column-secondary",
        headerClass: "control-column-secondary",
        render: (control) => displayValue("controlEvaluation", control.evaluation_status),
      },
      {
        key: "status",
    ...
    () => ({
      ...
      records: {
        controls: data.controls.map((control) => ({
          ...
          catalog_status: control.catalog_status,
          mapping_status: control.mapping_status,
          evaluation_status: control.evaluation_status,
          applicability: control.applicability,
          satisfaction: control.satisfaction,
          evaluation_scope: control.evaluation_scope,
