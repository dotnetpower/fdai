...
The Protocol is intentionally colocated with the Operator API delivery layer
...
from fdai.delivery.operator_api.persistence.in_memory_read_model import (
    InMemoryConsoleReadModel as _InMemoryConsoleReadModel,
)
from fdai.delivery.operator_api.persistence.rca_contracts import (
    RcaCausalChainView,
    RcaCausalHopView,
    RcaCitationView,
    RcaHypothesisView,
...
from fdai.delivery.operator_api.persistence.read_model_contracts import (
    DEFAULT_LIMIT,
...
class ConsoleReadModel(Protocol):
    ...
    Wired at the composition root; the Operator API handlers depend only on
