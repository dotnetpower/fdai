"""Truthful source provenance for the interactive local Operator API."""
    ...
    *,
    ...
    return (
        ...
        ReadDataSourceStatus(
            ...
            source="remote-operator-api" if remote_state else "repository-config",
            routes=("/stewardship",),
        ...
        ReadDataSourceStatus(
            key="onboarding",
            source="remote-operator-api" if remote_state else "not-configured",
            routes=("/onboarding",),
