"""Environment parsing for the local Operator API harness."""
...
_CORS_ORIGINS_ENV = "FDAI_OPERATOR_API_CORS_ALLOW_ORIGINS"
...
def local_entra_verifier_environment(
    ...
    """Map local Vite MSAL settings to the Operator API verifier contract."""
