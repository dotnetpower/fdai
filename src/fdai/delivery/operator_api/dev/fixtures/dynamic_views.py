...
def _group_mapping_from_env() -> GroupMapping:
    from fdai.delivery.operator_api.dev.local import _group_mapping_from_env as build
...
async def _build_dynamic_process_views(
    *,
    ...
    from fdai.delivery.operator_api.dev.fixtures.security_assessment import (
