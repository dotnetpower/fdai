"""Environment-driven helper wiring for the local Operator API factory."""
...
from fdai.delivery.operator_api.streaming.agent_activity_relay import (
...
from fdai.delivery.operator_api.streaming.live_control_loop import build_control_loop_emitter
...
def build_kubernetes_workload_provider() -> Any:
    from fdai.delivery.operator_api.dev.kubernetes_workloads import (
