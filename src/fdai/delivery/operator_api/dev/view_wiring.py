"""Catalog-driven view and user-context wiring for the local Operator API."""
...
from fdai.delivery.operator_api.dev.catalog_wiring import (
    LocalCatalogWiring,
    build_local_catalog_wiring,
)
from fdai.delivery.operator_api.dev.config import group_mapping_from_env
from fdai.delivery.operator_api.dev.fixtures.dynamic_views import (
    _build_dynamic_process_views_sync,
)
from fdai.delivery.operator_api.dev.user_context import build_local_user_context
from fdai.delivery.operator_api.routes.process_views import ProcessViewsConfig
from fdai.delivery.operator_api.routes.workflow_execution import WorkflowExecutionConfig
