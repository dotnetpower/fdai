"""Stable local-development Operator API factory facade."""
...
from fdai.delivery.operator_api.dev.azure_cli_identity import resolve_azure_cli_identity
from fdai.delivery.operator_api.dev.factory import (
