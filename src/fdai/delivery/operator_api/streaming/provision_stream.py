...
plumbing the live cockpit uses (:mod:`fdai.delivery.operator_api.live_stream`).
...
(:func:`~fdai.delivery.operator_api.streaming.live_stream.make_live_stream_route`) already
