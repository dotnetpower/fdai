...
(:mod:`fdai.delivery.operator_api.streaming.agent_activity_emitter`). This module
...
- **Pure reducer, no I/O.** :func:`project_stage` takes the prior
  ...
  (:mod:`fdai.delivery.operator_api.streaming.agent_activity_relay`) owns the I/O;
...
# attribution (fdai.delivery.operator_api.streaming.live_control_loop imports it).
