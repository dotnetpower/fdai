"""Read a complete audit window for autonomy measurement projection.

The module coordinates read-model pagination only. It owns no HTTP route,
authorization, persistence, approval, or execution behavior.
"""
...
from fdai.delivery.operator_api.projections.audit.audit_measurement_projection import audit_payload
...
async def _read_complete_window(
    ...
    *,
    ...
    """Read one fixed audit-head window and fail if pagination stalls."""
