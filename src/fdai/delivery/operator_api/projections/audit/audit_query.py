"""Parse bounded server-side audit query filters for read composition.

The parser owns normalization and validation only. It registers no route,
authorizes no principal, reads no state, and grants no approval or execution
authority.
"""
