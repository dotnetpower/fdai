"""Classify audit events for read-only autonomy measurements.

The module is a pure projection helper. It owns no HTTP, persistence, policy,
approval, or execution authority and does not retain mutable state.
"""
...
from fdai.delivery.operator_api.projections.verticals import audit_vertical
