...
:attr:`~fdai.delivery.operator_api.main.OperatorApiConfig.ontology_object_types`
AND :attr:`~fdai.delivery.operator_api.main.OperatorApiConfig.ontology_link_types`
