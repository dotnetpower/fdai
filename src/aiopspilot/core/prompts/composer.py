...
:class:`~aiopspilot.core.tools.ToolRegistry` is injected. Wave 3 step
C-1 adds a fourth: an optional **Operator Memory** layer that pulls
scope-bounded, HIL-approved notes from an
:class:`~aiopspilot.core.operator_memory.OperatorMemoryStore` and
...
from aiopspilot.core.measurement.prompt_probe import CanaryGenerator
...
from aiopspilot.core.prompts.registry import PromptRegistry
