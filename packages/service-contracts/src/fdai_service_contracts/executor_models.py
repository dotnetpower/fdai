...
class SafeguardBoundExecutorCommand(ContractBase):
...
AnyExecutorCommand = Union[ExecutorCommand, SafeguardBoundExecutorCommand]
...
class ObservationReceipt(ContractBase):
