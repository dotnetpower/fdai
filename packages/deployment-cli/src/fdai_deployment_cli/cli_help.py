...
AZURE_DESCRIPTION = (
    ...
    "A new source install confirms scope at startup only; later stages never prompt.\n"
    "Scope confirmation is not apply approval; --approval-file supplies exact approval.\n"
...
_ARGUMENT_HELP = {
    ...
    "--source": "Path to the clean committed FDAI source checkout",
    "--service": "One supported FDAI service to build and update",
    "--application-work-dir": "Retained private application work directory on the deployment host",
    "--timeout-seconds": "Total bounded command lifetime in seconds",
